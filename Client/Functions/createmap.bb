Function createmap%(arg0%)
    ...
    Local local31%
    Local local34.rooms
    arg0 = (Int max(min((Float arg0), 3.0), 0.0))
    Dim maptemp%((mapwidth + $01), (mapheight + $01))
    Dim mapfound%((mapwidth + $01), (mapheight + $01))
    debuglog(((("Generating a map using the seed " + randomseed) + " | map size: ") + (Str arg0)))
    i_zone\Field0[$00] = $0D
    i_zone\Field0[$01] = $07
    i_zone\Field1 = $00
    i_zone\Field2 = $00
    ...
    Repeat
        ...
        local6 = rand(($0A / (arg0 + $01)), ($0F / (arg0 + $01)))
        ...
        Next
        local7 = rand((Int max(2.0, (Float ($03 - arg0)))), ($04 - (arg0 Sar $01)))
    ...
    For local3 = $00 To $02 Step $01
        local2 = (Int (max(1.0, (Float ($05 - (arg0 Shl $01)))) + (Float (- local12[local3]))))
        If (local2 > $00) Then
    ...
    For local27 = Each rooms
        local27\Field6 = (Int wrapangle((Float local27\Field6)))
        local27\Field34[$00] = Null
        local27\Field34[$01] = Null
        local27\Field34[$02] = Null
        local27\Field34[$03] = Null
            ...
            If (local27 <> local34) Then
                If (local27\Field5 = local34\Field5) Then
                    If ((local27\Field3 + 8.0) = local34\Field3) Then
                        local27\Field34[$00] = local34
                        If (local27\Field35[$00] = Null) Then
                            local27\Field35[$00] = local34\Field35[$02]
                        EndIf
                    ElseIf ((local27\Field3 - 8.0) = local34\Field3) Then
                        local27\Field34[$02] = local34
                        If (local27\Field35[$02] = Null) Then
                            local27\Field35[$02] = local34\Field35[$00]
                        EndIf
                    EndIf
                ElseIf (local27\Field3 = local34\Field3) Then
                    If ((local27\Field5 - 8.0) = local34\Field5) Then
                        local27\Field34[$01] = local34
                        If (local27\Field35[$01] = Null) Then
                            local27\Field35[$01] = local34\Field35[$03]
                        EndIf
                    ElseIf ((local27\Field5 + 8.0) = local34\Field5) Then
                        local27\Field34[$03] = local34
                        If (local27\Field35[$03] = Null) Then
                            local27\Field35[$03] = local34\Field35[$01]
                        EndIf
                    EndIf
                EndIf
            EndIf
            If (((((local27\Field34[$00] <> Null) And (local27\Field34[$01] <> Null)) And (local27\Field34[$02] <> Null)) And (local27\Field34[$03] <> Null)) <> 0) Then
                Exit
            EndIf
        Next
    Next
