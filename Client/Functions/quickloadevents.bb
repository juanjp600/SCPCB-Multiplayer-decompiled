    ...
    Select local0\Field22
        ...
        Case $13
            ...
            If (0.0 = local0\Field2) Then
                ...
                ElseIf (local0\Field11 = "load1") Then
                    quickloadpercent = $14
                    local0\Field1\Field32[$00]\Field16 = loadsound_strict("SFX\Room\Storeroom\Escape1.ogg")
                    local0\Field11 = "load2"
                ElseIf (local0\Field11 = "load2") Then
                    quickloadpercent = $23
                    local0\Field1\Field32[$00]\Field17 = playsound2(local0\Field1\Field32[$00]\Field16, camera, local0\Field1\Field32[$00]\Field4, 12.0, 1.0)
                    local0\Field11 = "load3"
                ElseIf (local0\Field11 = "load3") Then
                    quickloadpercent = $37
                ...
                ElseIf (local0\Field11 = "load4") Then
                    quickloadpercent = $50
                    local0\Field1\Field32[$01]\Field16 = loadsound_strict("SFX\Room\Storeroom\Escape2.ogg")
                    local0\Field11 = "load5"
                ElseIf (local0\Field11 = "load5") Then
                    quickloadpercent = $64
                    pointentity(local0\Field1\Field32[$00]\Field4, local0\Field1\Field32[$01]\Field4, 0.0)
                    pointentity(local0\Field1\Field32[$01]\Field4, local0\Field1\Field32[$00]\Field4, 0.0)
                    local0\Field2 = 1.0
                EndIf
            EndIf
        Case $27
            ...
            EndIf
        Case $38
            If (((0.0 = local0\Field2) Or (local0\Field11 <> "loaddone")) <> 0) Then
                If (local0\Field11 = "load0") Then
        ...
        Case $39
            ...
            ElseIf (local0\Field11 = "load2") Then
                quickloadpercent = $64
                If (local0\Field1\Field32[$00] = Null) Then
                    local0\Field1\Field32[$00] = createnpc($0E, 0.0, 0.0, 0.0)
                EndIf
                local0\Field11 = "loaddone"
            EndIf
        Case $3A
