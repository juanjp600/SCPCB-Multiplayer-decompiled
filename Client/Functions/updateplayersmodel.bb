    ...
    For local0 = Each mp_player
        ...
        If (local0\Field35\Field0 <> $00) Then
            If ((hidedistance * hidedistance) > entitydistancesquared(local0\Field35\Field0, me\Field60)) Then
                ...
                EndIf
                If (((animseq(local0\Field35\Field0) <> local0\Field14) And (0.0 <> local0\Field35\Field1\Field24[local0\Field14])) <> 0) Then
                    animate(local0\Field35\Field0, $01, local0\Field35\Field1\Field24[local0\Field14], local0\Field14, 10.0)
                    local0\Field27 = ((((local0\Field14 = $04) Lor (local0\Field14 = $05)) Lor (local0\Field14 = $08)) Lor (local0\Field14 = $09))
                    positionentity(local0\Field19, 0.0, (((Float local0\Field27) * -0.3) + 0.6), 0.0, $00)
                EndIf
                If (((local0\Field35\Field2 <> $00) And (local0\Field35\Field1\Field28[local0\Field14] = $00)) <> 0) Then
                    ...
                    If (local0\Field35\Field1\Field7 > $00) Then
                        If (((isequal(0.0, angledist(local0\Field35\Field7, local2), (Float local0\Field35\Field1\Field7)) = $00) Or (0.001 < local0\Field23)) <> 0) Then
                        ...
                        If (local3 <= (Float (- local0\Field35\Field1\Field7))) Then
                            local2 = wrapangle((local0\Field35\Field7 + (Float local0\Field35\Field1\Field7)), 360.0)
                        ElseIf (local3 >= (Float local0\Field35\Field1\Field7)) Then
                            local2 = wrapangle((local0\Field35\Field7 - (Float local0\Field35\Field1\Field7)), 360.0)
                        EndIf
                    Else
                    ...
                    If (local0\Field35\Field1\Field8 <> 0) Then
                ...
                If (local0\Field35\Field3 <> $00) Then
                    ...
                    If (local0\Field35\Field1\Field8 <> 0) Then
                        rotateentity(local0\Field35\Field3, clamp(local0\Field12, (Float (- local5)), (Float local5)), local0\Field13, local0\Field35\Field8, $01)
                    Else
                        rotateentity(local0\Field35\Field3, clamp(local0\Field12, (Float (- local5)), (Float local5)), local0\Field13, entityroll(local0\Field35\Field3, $01), $01)
                    EndIf
                EndIf
                updateplayermodelsounds(local0)
                updateplayermodelselecteditem(local0)
            ElseIf (entityhidden(local0\Field35\Field0) = $00) Then
