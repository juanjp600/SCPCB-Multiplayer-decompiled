Function getscreenshot%()
    ...
    EndIf
    local2 = createbank(((opt\Field46 * opt\Field47) * $03))
    local3 = backbuffer()
    lockbuffer(local3)
    For local0 = $00 To (opt\Field46 - $01) Step $01
        For local1 = $00 To (opt\Field47 - $01) Step $01
            local4 = readpixelfast(local0, local1, local3)
            local5 = (((opt\Field46 * $03) * local1) + (local0 * $03))
    ...
    Next
    unlockbuffer(local3)
    local6 = fi_convertfromrawbits(local2, opt\Field46, opt\Field47, (opt\Field46 * $03), $18, $FF0000, $FF00, $FF, $01)
