                    ...
                    If (2.25 > local0) Then
                        If (arg0\Field79 <> 0) Then
                            If (rand($2BC, $01) = $01) Then
                                playsoundex(snd_i\Field46[rand($00, $02)], camera, arg0\Field0, 10.0, 1.0, $00)
                            EndIf
                ...
                Else
                    ...
                    If (local1 <> 0) Then
                        If (i_268\Field2 = $00) Then
                            arg0\Field15 = deltayaw(arg0\Field3, arg0\Field86\Field19)
                        EndIf
                        If (0.4225 > local0) Then
                            ...
                            If (arg0\Field79 <> 0) Then
                                If (chs\Field0 = $00) Then
                                    playsoundex(snd_i\Field53[rand($00, $02)], camera, arg0\Field0, 8.0, 1.0, $00)
