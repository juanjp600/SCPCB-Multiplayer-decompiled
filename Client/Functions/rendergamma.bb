Function rendergamma%()
    ...
    If (1.0 < opt\Field6) Then
        ...
        copyrect($00, $00, opt\Field49, opt\Field50, (Int (smallest_power_two_half - (Float mo\Field9))), (Int (smallest_power_two_half - (Float mo\Field10))), backbuffer(), texturebuffer(fresizetexture, $00))
    ...
    ElseIf (1.0 > opt\Field6) Then
        ...
        copyrect($00, $00, opt\Field49, opt\Field50, (Int (smallest_power_two_half - (Float mo\Field9))), (Int (smallest_power_two_half - (Float mo\Field10))), local3, texturebuffer(fresizetexture, $00))
        entityblend(fresizeimage, $01)
        clscolor($00, $00, $00)
        cls()
        scalerender((- local0), local0, local1, local1)
