Function updatedoors%()
    ...
    Local local15#
    Local local18%
    buttondirection = ((me\Field65 = $00) Lor (me\Field65 And ((infacility = $FFFFFFFF) Lor ((infacility <> $01) And (toelevatorfloor = $01)))))
    d_i\Field11 = $00
    d_i\Field9 = $00
    d_i\Field7 = Null
    For local0 = Each doors
        If (((((hidedistance * 1.75) * (hidedistance * 1.75)) >= entitydistancesquared(local0\Field2, me\Field60)) Lor (local0\Field22 > $00)) <> 0) Then
            local8 = ((local0\Field10 = $04) Lor (local0\Field10 = $05))
            local9 = ($01 - (local0\Field6 And local8))
            If (((((180.0 <= local0\Field8) Lor (0.0 >= local0\Field8)) And local9) And (grabbedentity = $00)) <> 0) Then
                ...
                Next
            EndIf
            local10 = (fps\Field7[$00] * 2.0)
            local11 = ((Float (local0\Field9 + $01)) - ((Float local0\Field27) * 0.375))
            If (local0\Field6 <> 0) Then
                If (180.0 > local0\Field8) Then
                    Select local0\Field10
                        Case $00
                            local0\Field8 = min(180.0, (local0\Field8 + (local10 * local11)))
                            local7 = (((sin(local0\Field8) * local11) * fps\Field7[$00]) / 80.0)
                        ...
                        Case $01
                            local0\Field8 = min(180.0, (local0\Field8 + (local10 * local11)))
                            local7 = (((sin(local0\Field8) * local11) * fps\Field7[$00]) / 162.0)
                            moveentity(local0\Field0, local7, 0.0, 0.0)
                            If (local0\Field1 <> $00) Then
                                moveentity(local0\Field1, local7, 0.0, 0.0)
                            EndIf
                        Case $02
                            ...
                            moveentity(local0\Field0, (((local6 * local11) * fps\Field7[$00]) / 85.0), 0.0, 0.0)
                            If (local0\Field1 <> $00) Then
                        ...
                        Case $06
                            ...
                            moveentity(local0\Field0, ((local6 * local11) * local7), 0.0, 0.0)
                            If (local0\Field1 <> $00) Then
                ...
                Else
                    ...
                    If (0.0 < local0\Field13) Then
                        ...
                        If ((local0\Field25 And ((110.0 < (local0\Field13 + fps\Field7[$00])) And (110.0 >= local0\Field13))) <> 0) Then
                            local0\Field17 = playsoundex(snd_i\Field10, camera, local0\Field0, 10.0, 1.0, $00)
                        EndIf
                        If (0.0 = local0\Field13) Then
                ...
                EndIf
            Else
                local13 = entityx(local0\Field2, $01)
                local14 = entityy(local0\Field2, $01)
                local15 = entityz(local0\Field2, $01)
                If (0.0 < local0\Field8) Then
                    Select local0\Field10
                        Case $00
                            local0\Field8 = max(0.0, (local0\Field8 - (local10 * local11)))
                            local7 = (((sin(local0\Field8) * local11) * (- fps\Field7[$00])) / 80.0)
                            moveentity(local0\Field0, local7, 0.0, 0.0)
                            If (local0\Field1 <> $00) Then
                                moveentity(local0\Field1, local7, 0.0, 0.0)
                        ...
                        Case $03
                            ...
                            If (((15.0 > local0\Field8) And (15.0 <= (local0\Field8 + fps\Field7[$00]))) <> 0) Then
                                setemitter(Null, local13, local14, local15, $0B)
                            EndIf
                        Case $04,$05
                            local0\Field8 = 0.0
                ...
                Else
                    local0\Field9 = $00
                    positionentity(local0\Field0, local13, local14, local15, $00)
                    If (local0\Field1 <> $00) Then
                        positionentity(local0\Field1, local13, local14, local15, $00)
                    EndIf
                    Select local0\Field10
                        Case $00,$06,$07
            ...
            If (local8 = $00) Then
                If (0.0 >= local0\Field26) Then
                    ...
                    For local4 = $00 To $01 Step $01
                        If (local0\Field3[local4] <> $00) Then
                            entitytexture(local0\Field3[local4], d_i\Field3[local18], $00, $00)
                        EndIf
                    Next
