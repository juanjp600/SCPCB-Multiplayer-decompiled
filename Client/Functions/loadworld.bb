            ...
            Case "soundemitter"
                For local4 = $00 To $03 Step $01
                    If (arg1\Field5[local4] = $00) Then
                        arg1\Field6[local4] = (entityx(local11, $00) * roomscale)
                        arg1\Field7[local4] = (entityy(local11, $00) * roomscale)
                        arg1\Field8[local4] = (entityz(local11, $00) * roomscale)
                        arg1\Field5[local4] = (Int keyvalue(local11, "sound", "0"))
                        arg1\Field9[local4] = (Float keyvalue(local11, "range", "1"))
                        Exit
                    EndIf
                Next
            Case "field_hit"
