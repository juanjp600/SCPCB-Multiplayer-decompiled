Function mp_updateitem%(arg0.items)
    ...
    Else
        If (arg0\Field30 <> 0) Then
            ...
            arg0\Field30 = $00
        EndIf
        If ((((mp_ishoster() = $00) And (0.0 >= arg0\Field31)) And (0.00003 <= distancesquared(entityx(arg0\Field2, $01), arg0\Field32, entityy(arg0\Field2, $01), arg0\Field33, entityz(arg0\Field2, $01), arg0\Field34))) <> 0) Then
