Function mp_renderchathud%()
    ...
    While (((local3 <> Null) And (local2 <= $32)) <> 0)
        ...
        color($1E, $1E, $1E)
        rowtextleft(local3\Field0, (Int ((2.0 * menuscale) + (Float local0))), (Int ((2.0 * menuscale) + (Float local1))), (Int ((500.0 * menuscale) + (4.0 * menuscale))), opt\Field47, (Int (25.0 * menuscale)))
        color($FF, $FF, $FF)
        rowtextleft(local3\Field0, local0, local1, (Int ((500.0 * menuscale) + (4.0 * menuscale))), opt\Field47, (Int (25.0 * menuscale)))
        local2 = (local2 + $01)
