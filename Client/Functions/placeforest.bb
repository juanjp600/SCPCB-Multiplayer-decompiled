            ...
            If (arg0\Field2[((local1 * $0A) + local0)] = $01) Then
                ...
                Select local3
                    ...
                    Case $04
                        ...
                        local3 = $05
                    Default
                        debuglog(("tile_type: " + (Str local3)))
                End Select
                If (local3 > $00) Then
                    setbuffer(imagebuffer(local10[local3], $00))
                    local16 = imagewidth(local10[local3])
                    local17 = (local8 / (Float local16))
                    For local18 = $03 To (local16 - $02) Step $01
                        For local19 = $03 To (local16 - $02) Step $01
                            getcolor(local18, (local16 - local19))
                                ...
                                Select rand($00, $07)
                                    Case $00,$01,$02,$03,$04,$05,$06
                                        ...
                                        For local9 = $00 To $03 Step $01
                                            local21 = copyentity(arg0\Field1[$03], $00)
                                            rotateentity(local21, 0.0, (rnd(-20.0, 20.0) + (Float ($5A * local9))), 0.0, $00)
                                            entityparent(local21, local5, $01)
                                            entityfx(local21, $01)
                                        Next
                                        scaleentity(local5, (local7 * 1.1), local7, (local7 * 1.1), $01)
                                        positionentity(local5, (((Float local18) * local17) - (local8 / 2.0)), (((Float colorred()) * 0.03) - rnd(3.0, 3.2)), (((Float local19) * local17) - (local8 / 2.0)), $01)
                                        rotateentity(local5, rnd(-5.0, 5.0), rnd(360.0, 0.0), 0.0, $01)
                                    Case $07
                                        local5 = copyentity(arg0\Field1[$01], $00)
                                        local7 = rnd(0.01, 0.012)
                                        positionentity(local5, (((Float local18) * local17) - (local8 / 2.0)), (((Float colorred()) * 0.03) - 1.3), (((Float local19) * local17) - (local8 / 2.0)), $01)
                                        entityfx(local5, $01)
                    ...
                    local23 = Null
                    If ((((local1 Mod $03) = $02) And (local22[(Int floor((Float (local1 / $03))))] = $00)) <> 0) Then
                        local22[(Int floor((Float (local1 / $03))))] = $01
                        local23 = createitem(("Log #" + (Str (Int (floor((Float (local1 / $03))) + 1.0)))), "paper", 0.0, 0.5, 0.0, $00, $00, $00, 1.0, $00, $01)
                        entitytype(local23\Field1, $03, $00)
                        entityparent(local23\Field1, local4, $01)
                    EndIf
                    ...
                    If (local23 <> Null) Then
                        entityparent(local23\Field1, $00, $01)
                    EndIf
