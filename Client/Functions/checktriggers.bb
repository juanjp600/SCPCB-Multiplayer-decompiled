Function checktriggers$(arg0.events)
    ...
    Local local2%
    Local local3%
    If (arg0\Field1\Field40 = $00) Then
        Return ""
    Else
        For local0 = $00 To (arg0\Field1\Field40 - $01) Step $01
            If (debughud <> 0) Then
                entitycolor(arg0\Field1\Field41[local0], 255.0, 255.0, 0.0)
                entityalpha(arg0\Field1\Field41[local0], 0.2)
            Else
