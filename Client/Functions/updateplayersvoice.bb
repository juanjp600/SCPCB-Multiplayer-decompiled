Function updateplayersvoice%()
    ...
    For local1 = Each mp_player
        bass_channelsetattribute(local1\Field36\Field0[$00], $02, ((max((1.0 - (entitydistance(local1\Field18, camera) / 15.0)), 0.0) * opt\Field21) * opt\Field16))
        ...
        bass_channelsetattribute(local1\Field36\Field0[$00], $02, (opt\Field21 * opt\Field16))
