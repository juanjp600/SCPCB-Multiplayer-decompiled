Function loadoptionsini%()
    ...
    key\Field14 = inigetint(optionfile, "Controls", "Voice Key", $2F, $01)
    key\Field15 = inigetint(optionfile, "Controls", "Chat Key", $15, $01)
    ...
    opt\Field46 = inigetint(optionfile, "Global", "Width", desktopwidth(), $01)
    opt\Field47 = inigetint(optionfile, "Global", "Height", desktopheight(), $01)
    opt\Field48 = inigetint(optionfile, "Global", "Display Mode", $01, $01)
    opt\Field49 = inigetint(optionfile, "Global", "GFX Driver", $01, $01)
    opt\Field50 = inigetint(optionfile, "Global", "Enable Intro", $01, $01)
    opt\Field51 = inigetint(optionfile, "Global", "Debug Mode", $00, $01)
    opt\Field52 = inigetstring(optionfile, "Global", "Language", "en", $01)
    opt\Field56 = inigetint(optionfile, "Global", "No Progress Bar", $00, $01)
    Return $00
End Function
