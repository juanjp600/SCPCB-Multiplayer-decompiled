Function mp_updateevents%()
    ...
    Local local103%
    Local local104%
    Local local107.waypoints
    Local local108$
    Local local109%
    Local local110.doors
    Local local111.doors
    Local local113%
    Local local114#
    Local local115#
    Local local116%
    ...
    If ((((mp_ishoster() = $00) And (mp_isconnected() = $00)) And (mp_iseventsreceived() = $00)) <> 0) Then
        Return $00
    EndIf
    event_prevplayerroom = playerroom
    event_prevplayercollider = me\Field60
    ...
    For local3 = Each events
        ...
        local3\Field20 = $01
        If (((local3\Field21 <> Null) And (local3\Field19 = $00)) <> 0) Then
            playerroom = mp_rooms[local3\Field21\Field22]
            me\Field60 = local3\Field21\Field18
            local3\Field20 = (local3\Field21 = ue_players[mp_getmyindex()])
        EndIf
        i_268\Field2 = (local3\Field20 * local49)
        ...
        Select local3\Field0
                ...
                If (local3\Field1\Field15[$03] = Null) Then
                    If (event_isplayerinroom(local3) <> 0) Then
                        ...
                        If (local3\Field1\Field15[$00] <> Null) Then
                            ...
                            setnpcframe(local3\Field1\Field15[$00], 74.0)
                        EndIf
                        ...
                        EndIf
                        setnpcframe(local3\Field1\Field15[$01], 210.0)
                        ...
                        setnpcframe(local3\Field1\Field15[$03], 286.0)
                        ...
                        setnpcframe(local3\Field1\Field15[$04], 677.0)
                        ...
                        setnpcframe(local3\Field1\Field15[$05], 779.0)
                        ...
                        If (0.0 = local3\Field3) Then
                            If (((900.0 < local3\Field2) And local3\Field1\Field14[$03]\Field6) <> 0) Then
                                If (900.0 >= (local3\Field2 - fps\Field7[$00])) Then
                                    ...
                                    local3\Field1\Field15[$01]\Field18 = playsoundex(local3\Field1\Field15[$01]\Field17, camera, local3\Field1\Field15[$01]\Field3, 10.0, 1.0, $01)
                                    ...
                                    local3\Field1\Field15[$02]\Field18 = playsoundex(local3\Field1\Field15[$02]\Field17, camera, local3\Field1\Field15[$02]\Field3, 10.0, 1.0, $01)
                                EndIf
                                ...
                                Else
                                    If (1180.0 > (local3\Field2 - fps\Field7[$00])) Then
                                        ...
                                        me\Field50 = 3.0
                                        me\Field10 = -10.0
                                        playsoundex(snd_i\Field12, camera, n_i\Field2\Field3, 10.0, 1.0, $00)
                        ...
                        If (local3\Field1\Field11[$01] <> $00) Then
                            ...
                            If (rand($12C, $01) = $02) Then
                                If (6.25 > entitydistancesquared(local3\Field1\Field11[$00], me\Field60)) Then
                                    playsoundex(snd_i\Field24[rand($03, $01)], camera, local3\Field1\Field11[$00], 3.0, 1.0, $00)
                                EndIf
                            EndIf
                        EndIf
                    EndIf
            ...
            Case $16
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    EndIf
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$01], local3\Field1\Field14[$02], local3\Field1\Field11[$02], local3\Field1\Field11[$03], local3, $01, $00, $00)
                EndIf
            ...
            Case $17
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    If (local3\Field1\Field15[$00] <> Null) Then
                        local3\Field20 = (event_ismeinroom(local3) And (-26.95312 > entityy(event_getmypivot(), $00)))
                        If (local3\Field20 <> 0) Then
                            shouldplay = $19
                            me\Field59 = $01
                        EndIf
                        If (((-26.95312 > entityy(me\Field60, $00)) Lor local3\Field20) <> 0) Then
                    ...
                    Else
                        ...
                        setnpcframe(local3\Field1\Field15[$00], 17.0)
                    EndIf
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local3\Field1\Field14[$01], local3\Field1\Field11[$02], local3\Field1\Field11[$03], local3, $01, $00, $00)
                Else
                    event_resetprev()
                            ...
                            If (((7.0 < local3\Field2) And remotedooron) <> 0) Then
                                ...
                                If (rand(((local3\Field1\Field14[$00]\Field6 * $96) + $96), $01) = $01) Then
                                    If (local3\Field1\Field14[$00]\Field6 <> 0) Then
                                        playsoundex(snd_i\Field3, camera, local3\Field1\Field14[$00]\Field2, 7.0, 1.0, $00)
                                    Else
                                        playsoundex(snd_i\Field4, camera, local3\Field1\Field14[$00]\Field2, 7.0, 1.0, $00)
                                    EndIf
                        ...
                        Select local3\Field2
                            ...
                            Case 5.0
                                ...
                                If (2800.0 < local3\Field3) Then
                                    playsoundex(loadtempsound("SFX\SCP\205\Horror.ogg"), camera, local3\Field1\Field11[$05], 10.0, 0.3, $00)
                                    local3\Field2 = (local3\Field2 + 1.0)
                                EndIf
                            Case 7.0
                                If (entityhidden(local3\Field1\Field16[$00]\Field4) <> 0) Then
                                ...
                                If (4200.0 < local3\Field3) Then
                                    playsoundex(loadtempsound("SFX\SCP\205\Horror.ogg"), camera, local3\Field1\Field11[$05], 10.0, 0.5, $00)
                                    local3\Field2 = (local3\Field2 + 1.0)
                                EndIf
                            Case 9.0
                                If (entityhidden(local3\Field1\Field16[$00]\Field4) <> 0) Then
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (2.0 > coffindistance) Then
                        ...
                        If (local3\Field1\Field15[$00] = Null) Then
                            ...
                            local3\Field1\Field15[$00]\Field18 = playsoundex(local3\Field1\Field15[$00]\Field17, camera, local3\Field1\Field15[$00]\Field3, 10.0, 1.0, $01)
                            rotateentity(local3\Field1\Field15[$00]\Field3, 0.0, ((Float local3\Field1\Field6) + 90.0), 0.0, $00)
                            setnpcframe(local3\Field1\Field15[$00], 270.0)
                    ...
                    ElseIf (6.0 < coffindistance) Then
                        If (local3\Field1\Field15[$00] <> Null) Then
                            If (local3\Field1\Field15[$00]\Field13 = $00) Then
                                ...
                                local3\Field1\Field15[$00]\Field18 = playsoundex(local3\Field1\Field15[$00]\Field17, camera, local3\Field1\Field15[$00]\Field3, 100.0, 1.0, $01)
                    ...
                    If (0.0 = local3\Field2) Then
                                ...
                                If (((local11\Field2 <> $00) And (local11\Field15 = $00)) <> 0) Then
                                    If (200.0 > (Abs (entityx(local11\Field2, $00) - (local3\Field1\Field3 - 2.78125)))) Then
                                        If (104.0 > (Abs (entityy(local11\Field2, $00) - (local3\Field1\Field4 + 2.53125)))) Then
                                            local3\Field6 = playsoundex(snd_i\Field59, camera, local3\Field1\Field11[$01], 10.0, 1.0, $00)
                                            local3\Field1\Field14[$01]\Field17 = playsoundex(loadtempsound("SFX\SCP\914\DoorClose.ogg"), camera, local3\Field1\Field14[$01]\Field0, 10.0, 1.0, $00)
                        ...
                        If (grabbedentity = local3\Field1\Field11[$01]) Then
                            ...
                            If (((((((-94.0 < local55) And (-86.0 > local55)) Lor ((-44.0 < local55) And (-36.0 > local55))) Lor ((-4.0 < local55) And (4.0 > local55))) Lor ((36.0 < local55) And (44.0 > local55))) Lor ((86.0 < local55) And (94.0 > local55))) <> 0) Then
                                If (local3\Field6 = $00) Then
                                    local3\Field6 = playsoundex(snd_i\Field31[rand($00, $01)], camera, local3\Field1\Field11[$01], 2.0, 0.5, $00)
                                EndIf
                            Else
                                local3\Field6 = $00
                            EndIf
                    ...
                    If (grabbedentity <> local3\Field1\Field11[$01]) Then
                        ...
                        If (((((((-90.0 = local37) Lor (-40.0 = local37)) Lor (-1.0 = local37)) Lor (0.0 = local37)) Lor (40.0 = local37)) Lor (90.0 = local37)) <> 0) Then
                            If (local3\Field7 = $00) Then
                                local3\Field7 = playsoundex(snd_i\Field31[rand($00, $01)], camera, local3\Field1\Field11[$01], 2.0, 0.5, $00)
                            EndIf
                        EndIf
                    EndIf
                    If (0.0 < local3\Field2) Then
                        ...
                        If (140.0 < local3\Field2) Then
                            If (local3\Field1\Field14[$00]\Field6 <> 0) Then
                                local3\Field1\Field14[$00]\Field17 = playsoundex(loadtempsound("SFX\SCP\914\DoorClose.ogg"), camera, local3\Field1\Field14[$00]\Field0, 10.0, 1.0, $00)
                            EndIf
                        ...
                        If (840.0 < local3\Field2) Then
                            ...
                            local59 = loadtempsound("SFX\SCP\914\DoorOpen.ogg")
                            local3\Field1\Field14[$00]\Field17 = playsoundex(local59, camera, local3\Field1\Field14[$00]\Field0, 10.0, 1.0, $00)
                            local3\Field1\Field14[$01]\Field17 = playsoundex(local59, camera, local3\Field1\Field14[$01]\Field0, 10.0, 1.0, $00)
                            me\Field9 = $01
                            local3\Field2 = 0.0
                        EndIf
                    EndIf
            ...
            Case $23
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    EndIf
                    local3\Field20 = (event_ismeinroom(local3) And (-17.5625 > entityy(event_getmypivot(), $00)))
                    If (((-17.5625 > entityy(me\Field60, $00)) Lor local3\Field20) <> 0) Then
                        If (local3\Field20 <> 0) Then
                                ...
                                If (0.0 = local3\Field3) Then
                                    If (9.0 > entitydistancesquared(n_i\Field2\Field3, local3\Field1\Field11[$04])) Then
                                        If (mp_somebodysees173(n_i\Field2) = $00) Then
                                            ...
                                            EndIf
                                            local3\Field7 = playsoundex(loadtempsound("SFX\Room\GlassBreak.ogg"), camera, local3\Field1\Field11[$00], 10.0, 1.0, $00)
                                            local3\Field3 = 1.0
                                        EndIf
                                    EndIf
                                EndIf
                    ...
                    ElseIf (1.0 = local3\Field2) Then
                        local3\Field2 = 0.0
                    EndIf
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$04], local3\Field1\Field14[$05], local3\Field1\Field11[$08], local3\Field1\Field11[$09], local3, $01, $00, $00)
                ElseIf (entityhidden(local3\Field1\Field11[$0A]) = $00) Then
                    hideentity(local3\Field1\Field11[$0A])
                EndIf
            Case $0E
                    ...
                    If (local3\Field8 = $00) Then
                        If (6.25 > entitydistancesquared(me\Field60, local3\Field1\Field14[$00]\Field0)) Then
                            If (((0.0 <= me\Field3) And remotedooron) <> 0) Then
                                ...
                                EndIf
                                playsoundex(snd_i\Field32, camera, local3\Field1\Field14[$00]\Field0, 10.0, 1.0, $00)
                                If (local3\Field1\Field14[$00]\Field6 = $00) Then
                                    openclosedoor(local3\Field1\Field14[$00], $01, $00)
                                EndIf
                                local3\Field2 = 1.0
            ...
            Case $24
                If (event_isplayerinroom(local3) <> 0) Then
                    local3\Field20 = (event_ismeinroom(local3) And (-11.125 >= entityy(event_getmypivot(), $00)))
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local3\Field1\Field14[$01], local3\Field1\Field11[$00], local3\Field1\Field11[$01], local3, $01, $00, $00)
                    local3\Field23 = mp_updateelevators(local3\Field23, local3\Field1\Field14[$02], local3\Field1\Field14[$03], local3\Field1\Field11[$02], local3\Field1\Field11[$03], local3, $01, $00, $00)
                    local60 = (0.0 > entitypitch(local3\Field1\Field13[$01]\Field0, $01))
                    ...
                    If ((local23 And (Int local34)) = $00) Then
                        local3\Field1\Field14[$01]\Field4 = $01
                        local3\Field1\Field14[$03]\Field4 = $01
                    EndIf
                    If (((-11.125 >= entityy(me\Field60, $00)) Lor local3\Field20) <> 0) Then
                        If (local3\Field20 <> 0) Then
                            shouldplay = $18
                            me\Field59 = $01
                        EndIf
                        If (local3\Field1\Field15[$00] = Null) Then
                            ...
                            entitytype(local11\Field2, $03, $00)
                        EndIf
                        If (((local34 <> (Float local60)) And event_ismeinroom(local3)) <> 0) Then
                        ...
                        If (70.0 <= local3\Field2) Then
                            If ((((wi\Field5 = $00) And (wi\Field9 = $00)) And local3\Field20) <> 0) Then
                        ...
                        If ((local23 And (Int local34)) <> 0) Then
                            If (0.0 < local3\Field1\Field15[$00]\Field26) Then
                                ...
                                If (local20 > $00) Then
                                    ...
                                    playsoundex(snd_i\Field42, camera, local3\Field1\Field11[local20], 4.0, 1.0, $00)
                                    local3\Field1\Field14[local20]\Field4 = $00
            ...
            Case $25
                If (event_isplayerinroom(local3) <> 0) Then
                    local3\Field20 = (event_ismeinroom(local3) And (-14.5625 > entityy(event_getmypivot(), $00)))
                    If (((-14.5625 > entityy(me\Field60, $00)) Lor local3\Field20) <> 0) Then
                        If (local3\Field20 <> 0) Then
                            shouldplay = $1B
                            me\Field59 = $01
                        EndIf
                        If (0.0 = local3\Field2) Then
                            ...
                            setnpcframe(local3\Field1\Field15[$00], 19.0)
                        ...
                        If (25.0 > entitydistancesquared(me\Field60, local3\Field1\Field11[$03])) Then
                            If (rand($32, $01) = $01) Then
                                ...
                                playsoundex(snd_i\Field62, camera, local3\Field1\Field11[$03], 3.0, 0.4, $00)
                            EndIf
                        EndIf
                    EndIf
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local3\Field1\Field14[$01], local3\Field1\Field11[$00], local3\Field1\Field11[$01], local3, $01, $00, $00)
            ...
            Case $0F
                ...
                EndIf
            Case $39
                local61 = local3\Field1\Field10
                If ((event_ismeinroom(local3) And (local61 <> Null)) <> 0) Then
                    If (1.0 = local3\Field2) Then
                        showroomsnocoll(local3\Field1)
                        updateforest(local61)
                        If (((local3\Field1\Field15[$00] = Null) And (0.0 = local3\Field5)) <> 0) Then
                            local3\Field1\Field15[$00] = createnpc($0A, 0.0, 0.0, 0.0)
                        EndIf
                        If (1.0 = local3\Field5) Then
                            shouldplay = $21
                            If (rand($64, $01) = $01) Then
                                me\Field23 = 0.7
                                me\Field30 = 0.7
                        ...
                        EndIf
                        If (local3\Field1\Field15[$00] <> Null) Then
                            If (((((1.0 = local3\Field1\Field15[$00]\Field11) And (1.0 < local3\Field1\Field15[$00]\Field10)) And (local3\Field1\Field15[$00]\Field86 = ue_players[mp_getmyindex()])) Lor (2.0 < local3\Field1\Field15[$00]\Field10)) <> 0) Then
                                shouldplay = $0C
                            EndIf
                        EndIf
                        If (chs\Field3 = $00) Then
                            If (28.5 >= entityy(me\Field60, $00)) Then
                                me\Field10 = -10.0
                                kill($00, $01, $00, $01)
                            ElseIf ((entityy(local61\Field4, $01) + 0.5) < entityy(me\Field60, $00)) Then
                                moveentity(me\Field60, 0.0, (((entityy(local61\Field4, $01) + 0.5) - entityy(me\Field60, $00)) * fps\Field7[$00]), 0.0)
                            EndIf
                        EndIf
                        If (local3\Field1\Field15[$00] <> Null) Then
                            ...
                            EndIf
                        EndIf
                        If ((local61\Field5[$00]\Field6 Lor local61\Field5[$01]\Field6) <> 0) Then
                            me\Field10 = -10.0
                        ...
                        EndIf
                    Else
                        If (entityhidden(local61\Field4) = $00) Then
                            hideentity(local61\Field4)
                        EndIf
                        For local20 = $00 To $01 Step $01
                            local61\Field5[local20]\Field6 = $00
                            local61\Field5[local20]\Field4 = $02
                        Next
                        If (local3\Field1\Field14[$00]\Field6 <> 0) Then
                            If (entityhidden(local61\Field4) <> 0) Then
                            ...
                            positionentity(me\Field60, entityx(local61\Field5[local20]\Field2, $01), ((entityy(local61\Field5[local20]\Field2, $01) + entityy(me\Field60, $01)) + 0.5), entityz(local61\Field5[local20]\Field2, $01), $01)
                            rotateentity(me\Field60, 0.0, (entityyaw(local61\Field5[local20]\Field2, $01) - 180.0), 0.0, $01)
                            moveentity(me\Field60, -0.5, 0.0, 0.5)
                            local61\Field5[$00]\Field4 = ($02 - local20)
                            local61\Field5[$01]\Field4 = ($01 + local20)
            ...
            Case $10
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (1.0 = local3\Field2) Then
                        ...
                        local3\Field1\Field15[$00]\Field87 = $01
                    ...
                    ElseIf (2.0 = local3\Field2) Then
                        ...
                        If (1000.0 < local3\Field3) Then
                            ...
                            If (((1040.0 <= local3\Field3) And (1040.0 > (local3\Field3 - fps\Field7[$00]))) <> 0) Then
                                local3\Field1\Field15[$00]\Field18 = playsoundex(loadtempsound("SFX\SCP\1123\Officer0.ogg"), camera, local3\Field1\Field15[$00]\Field0, 10.0, 1.0, $01)
                            ElseIf (((1400.0 <= local3\Field3) And (1400.0 > (local3\Field3 - fps\Field7[$00]))) <> 0) Then
                                local3\Field1\Field15[$00]\Field18 = playsoundex(loadtempsound("SFX\SCP\1123\Officer1.ogg"), camera, local3\Field1\Field15[$00]\Field0, 10.0, 1.0, $01)
                            EndIf
                    ...
                    ElseIf (5.0 = local3\Field2) Then
                        ...
                        If (500.0 < local3\Field3) Then
                            ...
                            entityparent(local5\Field0, local3\Field1\Field2, $01)
                            local3\Field1\Field15[$00]\Field18 = playsoundex(loadtempsound("SFX\SCP\1123\Officer2.ogg"), camera, local3\Field1\Field15[$00]\Field3, 7.0, 1.0, $01)
                            local3\Field2 = 6.0
                        EndIf
            ...
            Case $11
                ...
                If (event_ismeinroom(local3) <> 0) Then
                    local3\Field2 = 0.0
                    local62 = $01
                    local63 = createpivot(local3\Field1\Field2)
                    positionentity(local63, 976.0, 128.0, -640.0, $00)
                    For local11 = Each items
                    ...
                    If (((local62 And interactobject(local3\Field1\Field11[$00], 0.75, $00)) And (1.0 = local3\Field5)) <> 0) Then
                        local3\Field3 = (Float rand($00, (maxitemamount - $01)))
                        If (inventory((Int local3\Field3)) <> Null) Then
                            local3\Field4 = 1.0
                        Else
                            For local20 = $00 To (maxitemamount - $01) Step $01
                                local64 = (inventory((Int ((local3\Field3 + (Float local20)) Mod (Float maxitemamount)))) = Null)
                                If (local64 = $00) Then
                                    local3\Field3 = ((local3\Field3 + (Float local20)) Mod (Float maxitemamount))
                                EndIf
                                If (rand($08, $01) = $01) Then
                                    local3\Field4 = ((0.1 * (Float local64)) + 3.0)
                                    ...
                                    Select local3\Field2
                                        Case 1.0
                                            local65 = "Lost Key"
                                        Case 2.0
                                            local65 = "Disciplinary Hearing DH-S-4137-17092"
                                        Case 3.0
                                            local65 = "Coin"
                                        Case 4.0
                                            local65 = "Movie Ticket"
                                        Case 5.0
                                            local65 = "Old Badge"
                                    End Select
                                    For local11 = Each items
                                        If (local11\Field1 = local65) Then
                                            local3\Field4 = 1.0
                                            local3\Field2 = 0.0
                                            Exit
                                        EndIf
                        ...
                        For local19 = Each itemtemplates
                            ...
                            If (local67 <> 0) Then
                                ...
                                If (mp_ishoster() <> 0) Then
                                    local11 = createitem(local19\Field1, local19\Field2, entityx(local63, $01), entityy(local63, $01), entityz(local63, $01), $00, $00, $00, 1.0, $00)
                                    entitytype(local11\Field2, $03, $00)
                                EndIf
                    ...
                    ElseIf (3.0 <= local3\Field4) Then
                        ...
                        If (mp_ishoster() <> 0) Then
                            Select local3\Field2
                                Case 1.0
                                    local11 = createitem("Lost Key", $69, entityx(local63, $01), entityy(local63, $01), entityz(local63, $01), $00, $00, $00, 1.0, $00)
                                Case 2.0
                                    local11 = createitem("Disciplinary Hearing DH-S-4137-17092", $01, entityx(local63, $01), entityy(local63, $01), entityz(local63, $01), $00, $00, $00, 1.0, $00)
                                Case 3.0
                                    local11 = createitem("Coin", $6B, entityx(local63, $01), entityy(local63, $01), entityz(local63, $01), $00, $00, $00, 1.0, $00)
                                Case 4.0
                                    local11 = createitem("Movie Ticket", $07, entityx(local63, $01), entityy(local63, $01), entityz(local63, $01), $00, $00, $00, 1.0, $00)
                                Case 5.0
                                    local11 = createitem("Old Badge", $06, entityx(local63, $01), entityy(local63, $01), entityz(local63, $01), $00, $00, $00, 1.0, $00)
                            End Select
                            entitytype(local11\Field2, $03, $00)
                        EndIf
                        giveachievement("1162arc", $01)
                        ...
                        If (remotedooron <> 0) Then
                            ...
                            For local20 = $00 To $01 Step $01
                                If (local3\Field1\Field14[local20]\Field6 = $00) Then
                                    local3\Field1\Field14[local20]\Field17 = playsoundex(snd_i\Field4, camera, local3\Field1\Field14[local20]\Field2, 5.0, 1.0, $00)
                                    openclosedoor(local3\Field1\Field14[local20], $01, $00)
                                EndIf
                            Next
                        EndIf
                ...
                Select local3\Field2
                    ...
                    Case 1.0
                        If ((event_isplayerinroom(local3) And (2.25 > entitydistancesquared(me\Field60, local3\Field1\Field11[$00]))) <> 0) Then
                            ...
                            local3\Field6 = playsoundex(loadtempsound("SFX\SCP\Joke\789J.ogg"), camera, local3\Field1\Field11[$00], 10.0, 1.0, $01)
                            local3\Field2 = 2.0
                        EndIf
                    Case 2.0
                ...
                Select local3\Field2
                    Case 0.0
                        If (((6.0 > local3\Field16) And (0.0 < local3\Field16)) <> 0) Then
                            ...
                            local3\Field1\Field15[$00]\Field10 = 8.0
                            local3\Field1\Field15[$00]\Field50 = $01
                            setnpcframe(local3\Field1\Field15[$00], 287.0)
                    ...
                    Case 2.0
                        ...
                        freesound_strict(local3\Field1\Field15[$00]\Field17)
                        local3\Field1\Field15[$00]\Field17 = $00
                        local3\Field1\Field15[$00]\Field18 = playsoundex(loadtempsound("SFX\Character\Guard\SuicideGuard1.ogg"), camera, local3\Field1\Field15[$00]\Field3, 12.0, 1.0, $01)
                        local3\Field2 = 3.0
                    Case 3.0
            ...
            Case $42
                ...
                If (local3\Field2 <> (Float local3\Field1\Field14[$00]\Field6)) Then
                    ...
                    EndIf
                    local3\Field6 = playsoundex(local3\Field8, camera, local3\Field1\Field14[$00]\Field0, 10.0, 1.0, $00)
                    local3\Field7 = playsoundex(local3\Field8, camera, local3\Field1\Field14[$01]\Field0, 10.0, 1.0, $00)
                EndIf
                    ...
                    If (0.0 = local3\Field2) Then
                        If (((8.0 > local3\Field16) And (0.0 < local3\Field16)) <> 0) Then
                            ...
                            Else
                                ...
                                playsoundex(loadtempsound("SFX\Door\EndroomDoor.ogg"), camera, local3\Field1\Field2, 15.0, 1.0, $00)
                                local3\Field2 = 1.0
                            EndIf
                        EndIf
                    ElseIf (1.0 = local3\Field2) Then
                    ...
                    Else
                        ...
                        If (7.74 < entitydistancesquared(local3\Field1\Field15[$00]\Field3, local3\Field1\Field14[$00]\Field2)) Then
                            If (1.0 = local3\Field1\Field15[$00]\Field10) Then
                                setnpcframe(local3\Field1\Field15[$00], 41.0)
                            EndIf
            ...
            Case $08
                If (local3\Field1\Field15[$00] = Null) Then
                    If ((event_isplayerinroom(local3) And (2.0 > n_i\Field2\Field26)) <> 0) Then
                        ...
                        local3\Field1\Field15[$00]\Field18 = playsoundex(loadtempsound("SFX\Character\Maintenance\EscapeFromClosets.ogg"), camera, local3\Field1\Field15[$00]\Field3, 12.0, 1.0, $01)
                ...
                Else
                    ...
                    If (210.0 > local3\Field2) Then
                        ...
                        If (((203.0 < local3\Field2) And (203.0 >= (local3\Field2 - fps\Field7[$00]))) <> 0) Then
                            playsoundex(loadtempsound("SFX\Room\Intro\173Vent.ogg"), camera, local3\Field1\Field2, 15.0, 1.0, $00)
                        EndIf
                    ElseIf (455.0 > local3\Field2) Then
                        If (210.0 > (local3\Field2 - fps\Field7[$00])) Then
                            local3\Field1\Field15[$00]\Field10 = 0.0
                            local3\Field1\Field15[$01]\Field18 = playsoundex(loadtempsound("SFX\Character\Scientist\EscapeFromClosets.ogg"), camera, local3\Field1\Field15[$01]\Field3, 12.0, 1.0, $01)
                        EndIf
                    ...
                    Else
                        ...
                        If (((525.0 < local3\Field2) And (525.0 >= (local3\Field2 - fps\Field7[$00]))) <> 0) Then
                            ...
                            If (wi\Field5 > $00) Then
                                me\Field10 = -10.0
                            EndIf
                            playsoundex(snd_i\Field53[$00], camera, local3\Field1\Field15[$00]\Field3, 8.0, 1.0, $00)
                        ...
                        ElseIf (((560.0 < local3\Field2) And (560.0 >= (local3\Field2 - fps\Field7[$00]))) <> 0) Then
                            ...
                            If (wi\Field5 > $00) Then
                                me\Field10 = -10.0
                            EndIf
                            playsoundex(snd_i\Field53[$01], camera, local3\Field1\Field15[$01]\Field3, 8.0, 1.0, $00)
                    ...
                    If (mp_interactobject(local3\Field1, $00, 1.0, $00, $00) <> 0) Then
                        ...
                        If (2.0 > local3\Field3) Then
                            If (selecteditem <> Null) Then
                                ...
                                ElseIf (((selecteditem\Field4\Field2 = $61) Lor (selecteditem\Field4\Field2 = $62)) <> 0) Then
                                    me\Field64 = ((selecteditem\Field4\Field2 = $62) + $01)
                                    If (0.0 < selecteditem\Field12) Then
                                        selecteditem\Field12 = (selecteditem\Field12 - 1.0)
                                        me\Field63 = (Int selecteditem\Field12)
                        ...
                        If (2.0 = local3\Field3) Then
                            ...
                            If (i_294\Field0 <> 0) Then
                                ...
                                mo\Field0 = $00
                            EndIf
                        ElseIf ((((1.0 = local3\Field3) And (local72 = $00)) And (me\Field64 = $00)) <> 0) Then
                            i_294\Field0 = $00
                            createmsg(getlocalstring("msg", "294.another"), 6.0)
                        ElseIf (((local72 = $00) And (me\Field64 = $00)) <> 0) Then
                            i_294\Field0 = $00
                            createmsg(getlocalstring("msg", "294.two"), 6.0)
                        ElseIf (me\Field64 > $00) Then
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    Else
                        ...
                        For local2 = Each rooms
                            ...
                            EndIf
                        Next
                        local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local73\Field14[$01], local3\Field1\Field11[$00], local3\Field1\Field11[$01], local3, $01, $01, $00)
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    Else
                        ...
                        For local2 = Each rooms
                            ...
                            EndIf
                        Next
                        local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local74\Field14[$01], local3\Field1\Field11[$00], local3\Field1\Field11[$01], local3, $01, $00, $00)
                        If (n_i\Field3\Field65 = $00) Then
                            If (((-1.5 > local3\Field22) And (-1.5 <= (local3\Field22 + fps\Field7[$00]))) <> 0) Then
            ...
            Case $3A
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (((local75 <> local3\Field3) And (0.0 < local3\Field2)) <> 0) Then
                        playsoundex(snd_i\Field34, camera, local3\Field1\Field13[$01]\Field0, 10.0, 1.0, $00)
                    EndIf
                ...
                If (16.0 > local3\Field16) Then
                    If (0.0 > local3\Field2) Then
                        ...
                        ElseIf (((0.0 = (Float local23)) And (1.0 = local3\Field3)) <> 0) Then
                            local3\Field7 = playsoundex(loadtempsound("SFX\Ambient\Room Ambience\FanOn.ogg"), camera, local3\Field1\Field11[$00], 8.0, 1.0, $00)
                        ElseIf (((1.0 = (Float local23)) And (0.0 = local3\Field3)) <> 0) Then
                            local3\Field7 = playsoundex(loadtempsound("SFX\Ambient\Room Ambience\FanOff.ogg"), camera, local3\Field1\Field11[$00], 8.0, 1.0, $00)
                        EndIf
            ...
            Case $1F
                If (6.0 > local3\Field16) Then
                    If (local3\Field1\Field15[$00] = Null) Then
                        ...
                        setnpcframe(local3\Field1\Field15[$00], 40.0)
                        rotateentity(local3\Field1\Field15[$00]\Field3, 0.0, ((Float local3\Field1\Field6) + 90.0), 0.0, $01)
                    EndIf
                EndIf
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    ElseIf (local3\Field1\Field17[$07] <> Null) Then
                        ...
                        Next
                    EndIf
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local3\Field1\Field14[$01], local3\Field1\Field11[$00], local3\Field1\Field11[$01], local3, $01, $00, $01)
                EndIf
            Case $31
                If (event_isplayerinroom(local3) <> 0) Then
                    If (local3\Field1\Field11[$00] = $00) Then
                ...
                If (16.0 > local3\Field16) Then
                    ...
                    Select local3\Field2
                        Case 0.0
                            ...
                            If (((chs\Field2 = $00) And ((local3\Field1\Field15[$00] = Null) Lor local3\Field1\Field15[$00]\Field50)) <> 0) Then
                                For local83 = Each mp_player
                                    If (((mp_rooms[local83\Field22] = local3\Field1) And (entityhidden(local83\Field18) = $00)) <> 0) Then
                                        If ((((1.0 > (Abs (entityx(local83\Field18, $01) - local34))) And (1.0 > (Abs (entityz(local83\Field18, $01) - local36)))) And (1.3 > (Abs (entityy(local83\Field18, $01) - local35)))) <> 0) Then
                                            If (channelplaying(local3\Field6) <> 0) Then
                                                stopchannel(local3\Field6)
                                                local3\Field6 = $00
                                            EndIf
                                            local3\Field6 = playsoundex(snd_i\Field17, camera, local3\Field1\Field11[$00], 4.0, 0.5, $00)
                                            local3\Field2 = 1.0
                                        EndIf
                                    EndIf
                                Next
                        ...
                        Case 1.0
                            ...
                            If (35.0 <= local3\Field3) Then
                                stopchannel(local3\Field7)
                                local3\Field7 = $00
                                local3\Field7 = playsoundex(snd_i\Field19, camera, local3\Field1\Field11[$00], 10.0, 1.0, $00)
                                local3\Field2 = 2.0
                            EndIf
                        Case 2.0
                            local34 = entityx(local3\Field1\Field2, $01)
                            ...
                            If (0.0 >= local3\Field3) Then
                                stopchannel(local3\Field6)
                                local3\Field6 = $00
                                local3\Field6 = playsoundex(snd_i\Field18, camera, local3\Field1\Field11[$00], 4.0, 0.5, $00)
                                local3\Field2 = 3.0
                                local3\Field3 = -70.0
                            EndIf
                        Case 3.0
            ...
            Case $1E
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (local3\Field1\Field18 = Null) Then
                        ...
                        local96 = (rand($00, $01) Shl $01)
                        local93 = (rand($FFFFFFFE, $02) + $09)
                        local94 = (rand($FFFFFFFE, $02) + $09)
                        local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $01
                        local3\Field1\Field18\Field0[((((local96 = $02) + local93) - (local96 <> $02)) + (local94 * $13))] = $01
                        local97 = $02
                        While (local97 < $64)
                            local91 = (rand($05, $01) Shl rand($02, $01))
                            For local20 = $01 To local91 Step $01
                                local92 = $01
                                ...
                                End Select
                                If (local92 <> 0) Then
                                    If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $00) Then
                                        local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $01
                                        local97 = (local97 + $01)
                                    EndIf
                                Else
                                ...
                                EndIf
                            Next
                            local96 = (local96 + ((rand($00, $01) Shl $01) - $01))
                            While (local96 < $00)
                                local96 = (local96 + $04)
                            Wend
                            While (local96 > $03)
                            ...
                            Wend
                        Wend
                        For local94 = $00 To $12 Step $01
                            For local93 = $00 To $12 Step $01
                                If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] > $00) Then
                                    local3\Field1\Field18\Field0[((local94 * $13) + local93)] = ((((local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] > $00) + (local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)] > $00)) + (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] > $00)) + (local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] > $00))
                                EndIf
                            Next
                        Next
                        local99 = $12
                        local100 = $00
                        For local93 = $00 To local99 Step $01
                            For local94 = $00 To $12 Step $01
                                If (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] > $00) Then
                                    local99 = local93
                                    If (((local3\Field1\Field18\Field0[((local93 + $01) + ((local94 + $01) * $13))] < $03) And (local3\Field1\Field18\Field0[((local93 + $01) + ((local94 - $01) * $13))] < $03)) <> 0) Then
                                        local100 = $01
                                        If (rand($00, $01) = $01) Then
                                            local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] = (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] + $01)
                                            local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $07
                                            local100 = $00
                                            Exit
                                        EndIf
                                    EndIf
                        ...
                        For local94 = $00 To $12 Step $01
                            For local93 = $00 To $12 Step $01
                                If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $02) Then
                                    If (((local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] > $00) And (local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] > $00)) <> 0) Then
                                        If (((local101 = $FFFFFFFF) Lor (local103 = $FFFFFFFF)) <> 0) Then
                                            If (((((local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] < $03) And (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] < $03)) And (local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)] < $03)) And (local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] < $03)) <> 0) Then
                                                If (((((local3\Field1\Field18\Field0[((local93 - $01) + ((local94 - $01) * $13))] < $01) And (local3\Field1\Field18\Field0[((local93 + $01) + ((local94 - $01) * $13))] < $01)) And (local3\Field1\Field18\Field0[((local93 + $01) + ((local94 - $01) * $13))] < $01)) And (local3\Field1\Field18\Field0[((local93 - $01) + ((local94 + $01) * $13))] < $01)) <> 0) Then
                                                    local101 = local93
                                                    local103 = local94
                                                EndIf
                                            EndIf
                                        ...
                                        If (((((local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] < $03) And (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] < $03)) And (local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)] < $03)) And (local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] < $03)) <> 0) Then
                                            ...
                                            EndIf
                                        EndIf
                                    ElseIf (((local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] > $00) And (local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)] > $00)) <> 0) Then
                                        If (((local101 = $FFFFFFFF) Lor (local103 = $FFFFFFFF)) <> 0) Then
                                            If (((((local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] < $03) And (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] < $03)) And (local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)] < $03)) And (local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] < $03)) <> 0) Then
                                                If (((((local3\Field1\Field18\Field0[((local93 - $01) + ((local94 - $01) * $13))] < $01) And (local3\Field1\Field18\Field0[((local93 + $01) + ((local94 - $01) * $13))] < $01)) And (local3\Field1\Field18\Field0[((local93 + $01) + ((local94 - $01) * $13))] < $01)) And (local3\Field1\Field18\Field0[((local93 - $01) + ((local94 + $01) * $13))] < $01)) <> 0) Then
                                                    local101 = local93
                            ...
                            Next
                        Next
                        If (((local102 = local101) And (local104 = local103)) <> 0) Then
                            runtimeerrorex(getlocalstring("runerr", "mt"))
                        EndIf
                        For local20 = $00 To $06 Step $01
                            local86[local20] = copyentity(misc_i\Field0[local20], $00)
                            hideentity(local86[local20])
                        Next
                        local91 = $00
                        For local94 = $00 To $12 Step $01
                            For local93 = $00 To $12 Step $01
                                If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] > $00) Then
                                    Select local3\Field1\Field18\Field0[((local94 * $13) + local93)]
                                        Case $01,$07
                                            local91 = copyentity(local86[(local3\Field1\Field18\Field0[((local94 * $13) + local93)] - $01)], $00)
                                            If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $01) Then
                                                addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.597656), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                            EndIf
                                            If (local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] > $00) Then
                                                rotateentity(local91, 0.0, 90.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $01
                                            ElseIf (local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] > $00) Then
                                                rotateentity(local91, 0.0, 270.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $03
                                            ElseIf (local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] > $00) Then
                                                rotateentity(local91, 0.0, 180.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $02
                                            Else
                                                rotateentity(local91, 0.0, 0.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $00
                                            EndIf
                                        Case $02
                                            If ((((local93 = local101) And (local94 = local103)) Lor ((local93 = local102) And (local94 = local104))) <> 0) Then
                                                local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $06
                                            EndIf
                                            If (((local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))] > $00) And (local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))] > $00)) <> 0) Then
                                                local91 = copyentity(local86[(local3\Field1\Field18\Field0[((local94 * $13) + local93)] - $01)], $00)
                                                addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.597656), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                                local92 = rand($00, $01)
                                                rotateentity(local91, 0.0, (((Float local92) * 180.0) + 90.0), 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = ((local92 Shl $01) + $01)
                                            ElseIf (((local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)] > $00) And (local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)] > $00)) <> 0) Then
                                                local91 = copyentity(local86[(local3\Field1\Field18\Field0[((local94 * $13) + local93)] - $01)], $00)
                                                addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.597656), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                                local92 = rand($00, $01)
                                                rotateentity(local91, 0.0, ((Float local92) * 180.0), 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = (local92 Shl $01)
                                            Else
                                                local91 = copyentity(local86[local3\Field1\Field18\Field0[((local94 * $13) + local93)]], $00)
                                                addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.65625), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                                local87 = local3\Field1\Field18\Field0[(((local94 + $01) * $13) + local93)]
                                                local88 = local3\Field1\Field18\Field0[(((local94 - $01) * $13) + local93)]
                                                local89 = local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))]
                                                local90 = local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))]
                                                If (((local87 > $00) And (local89 > $00)) <> 0) Then
                                                    rotateentity(local91, 0.0, 0.0, 0.0, $00)
                                                    local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $00
                                                ElseIf (((local87 > $00) And (local90 > $00)) <> 0) Then
                                                    rotateentity(local91, 0.0, 90.0, 0.0, $00)
                                                    local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $01
                                                ElseIf (((local88 > $00) And (local89 > $00)) <> 0) Then
                                                    rotateentity(local91, 0.0, 270.0, 0.0, $00)
                                                    local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $03
                                                Else
                                                    rotateentity(local91, 0.0, 180.0, 0.0, $00)
                                                ...
                                                EndIf
                                            EndIf
                                            If (((local93 = local101) And (local94 = local103)) <> 0) Then
                                                local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $05
                                            EndIf
                                        Case $03
                                            local91 = copyentity(local86[local3\Field1\Field18\Field0[((local94 * $13) + local93)]], $00)
                                            addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.65625), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                            ...
                                            local89 = local3\Field1\Field18\Field0[((local93 + $01) + (local94 * $13))]
                                            local90 = local3\Field1\Field18\Field0[((local93 - $01) + (local94 * $13))]
                                            If ((((local87 > $00) And (local89 > $00)) And (local90 > $00)) <> 0) Then
                                                rotateentity(local91, 0.0, 90.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $01
                                            ElseIf ((((local88 > $00) And (local89 > $00)) And (local90 > $00)) <> 0) Then
                                                rotateentity(local91, 0.0, 270.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $03
                                            ElseIf ((((local89 > $00) And (local87 > $00)) And (local88 > $00)) <> 0) Then
                                                rotateentity(local91, 0.0, 0.0, 0.0, $00)
                                                local3\Field1\Field18\Field1[((local94 * $13) + local93)] = $00
                                            Else
                                                rotateentity(local91, 0.0, 180.0, 0.0, $00)
                                        ...
                                        Case $04
                                            ...
                                            addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.65625), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                            local92 = rand($00, $03)
                                            rotateentity(local91, 0.0, ((Float local92) * 90.0), 0.0, $00)
                                            local3\Field1\Field18\Field1[((local94 * $13) + local93)] = local92
                                    End Select
                                    scaleentity(local91, (1.0 / 256.0), (1.0 / 256.0), (1.0 / 256.0), $01)
                                    positionentity(local91, (local3\Field1\Field3 + ((Float local93) * 2.0)), (local3\Field1\Field4 + 8.0), (local3\Field1\Field5 + ((Float local94) * 2.0)), $01)
                                    local37 = entityyaw(local91, $01)
                                    local45 = sin(local37)
                                    local46 = cos(local37)
                                    If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $07) Then
                                        addlight(local3\Field1, (((local3\Field1\Field3 + ((Float local93) * 2.0)) - ((local45 * 521.0) * (1.0 / 256.0))) + ((local46 * 16.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + (1.0 / 0.64)), (((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local46 * 521.0) * (1.0 / 256.0))) + ((local45 * 16.0) * (1.0 / 256.0))), $02, 0.425, $FF, $C8, $C8, $01)
                                        createprop(local3\Field1, "GFX\Map\Props\tank2.b3d", (((local3\Field1\Field3 + ((Float local93) * 2.0)) - ((local45 * 369.0) * (1.0 / 256.0))) + ((local46 * 320.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) - 0.5625), (((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local46 * 369.0) * (1.0 / 256.0))) + ((local45 * 320.0) * (1.0 / 256.0))), 0.0, (local37 + 180.0), 0.0, 3.0, 3.0, 3.0, $01, $00, "")
                                        createprop(local3\Field1, "GFX\Map\Props\tank2.b3d", (((local3\Field1\Field3 + ((Float local93) * 2.0)) - ((local45 * 977.0) * (1.0 / 256.0))) + ((local46 * 320.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) - 0.5625), (((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local46 * 977.0) * (1.0 / 256.0))) + ((local45 * 320.0) * (1.0 / 256.0))), 0.0, (local37 + 180.0), 0.0, 3.0, 3.0, 3.0, $01, $00, "")
                                        local11 = createitem("SCP-500-01", $16, (((local3\Field1\Field3 + ((Float local93) * 2.0)) + ((local46 * -208.0) * (1.0 / 256.0))) - ((local45 * 1226.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + (1.0 / 2.327273)), (((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local45 * -208.0) * (1.0 / 256.0))) + ((local46 * 1226.0) * (1.0 / 256.0))), $00, $00, $00, 1.0, $00)
                                        entitytype(local11\Field2, $03, $00)
                                        local11 = createitem("Night Vision Goggles", $40, (((local3\Field1\Field3 + ((Float local93) * 2.0)) - ((local45 * 504.0) * (1.0 / 256.0))) + ((local46 * 16.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + (1.0 / 2.844445)), (((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local46 * 504.0) * (1.0 / 256.0))) + ((local45 * 16.0) * (1.0 / 256.0))), $00, $00, $00, 1.0, $00)
                                        entitytype(local11\Field2, $03, $00)
                                    ElseIf (((local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $05) Lor (local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $06)) <> 0) Then
                                        addlight(local3\Field1, ((local3\Field1\Field3 + ((Float local93) * 2.0)) + ((local46 * 560.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + 1.832031), ((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local45 * 560.0) * (1.0 / 256.0))), $02, 0.25, $FF, $C8, $C8, $01)
                                        createprop(local3\Field1, "GFX\Map\Props\lamp_e.b3d", (((local3\Field1\Field3 + ((Float local93) * 2.0)) + ((local45 * 252.0) * (1.0 / 256.0))) + ((local46 * 560.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + 1.6875), (((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local46 * 252.0) * (1.0 / 256.0))) + ((local45 * 560.0) * (1.0 / 256.0))), 0.0, (local37 + 270.0), 90.0, 400.0, 400.0, 400.0, $00, $00, "")
                                        createprop(local3\Field1, "GFX\Map\Props\lamp_e.b3d", (((local3\Field1\Field3 + ((Float local93) * 2.0)) - ((local45 * 252.0) * (1.0 / 256.0))) + ((local46 * 560.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + 1.6875), (((local3\Field1\Field5 + ((Float local94) * 2.0)) - ((local46 * 252.0) * (1.0 / 256.0))) + ((local45 * 560.0) * (1.0 / 256.0))), 0.0, (local37 + 90.0), 90.0, 400.0, 400.0, 400.0, $00, $00, "")
                                        local16 = createdoor(Null, ((local3\Field1\Field3 + ((Float local93) * 2.0)) + ((local46 * 256.0) * (1.0 / 256.0))), (local3\Field1\Field4 + 8.0), ((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local45 * 256.0) * (1.0 / 256.0))), (local37 - 90.0), $00, $01, $00, $00, $00)
                                        ...
                                        positionentity(local92, ((local3\Field1\Field3 + ((Float local93) * 2.0)) + ((local46 * 552.0) * (1.0 / 256.0))), ((local3\Field1\Field4 + 8.0) + 0.9375), ((local3\Field1\Field5 + ((Float local94) * 2.0)) + ((local45 * 552.0) * (1.0 / 256.0))), $00)
                                        If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] = $06) Then
                                            ...
                                            If (local3\Field1\Field11[$03] = $00) Then
                                                local3\Field1\Field11[$03] = local92
                                                rotateentity(local3\Field1\Field11[$03], 0.0, local37, 0.0, $01)
                                                positionentity(local3\Field1\Field11[$01], (local3\Field1\Field3 + ((Float local93) * 2.0)), entityy(local3\Field1\Field11[$01], $01), (local3\Field1\Field5 + ((Float local94) * 2.0)), $01)
                                            Else
                                                freeentity(local92)
                                                local92 = $00
                                            EndIf
                                        Else
                                            ...
                                            If (local3\Field1\Field11[$05] = $00) Then
                                                local3\Field1\Field11[$05] = local92
                                                rotateentity(local3\Field1\Field11[$05], 0.0, (local37 + 180.0), 0.0, $01)
                                                positionentity(local3\Field1\Field11[$00], (local3\Field1\Field3 + ((Float local93) * 2.0)), entityy(local3\Field1\Field11[$00], $01), (local3\Field1\Field5 + ((Float local94) * 2.0)), $01)
                                            Else
                                                freeentity(local92)
                                                local92 = $00
                                            EndIf
                                        EndIf
                                    EndIf
                                    local3\Field1\Field18\Field3[((local94 * $13) + local93)] = local91
                                    local15 = createwaypoint(Null, local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 0.2), (local3\Field1\Field5 + ((Float local94) * 2.0)))
                                    local3\Field1\Field18\Field4[((local94 * $13) + local93)] = local15
                                    If (local94 < $12) Then
                                        If (local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)] <> Null) Then
                                            local38 = entitydistance(local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field0, local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]\Field0)
                                            For local20 = $00 To $03 Step $01
                                                If (local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]) Then
                                                    Exit
                                                ElseIf (local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = Null) Then
                                                    local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]
                                                    local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field5[local20] = local38
                                                    Exit
                                                EndIf
                                            Next
                                            For local20 = $00 To $03 Step $01
                                                If (local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]\Field4[local20] = local3\Field1\Field18\Field4[((local94 * $13) + local93)]) Then
                                                    Exit
                                                ElseIf (local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]\Field4[local20] = Null) Then
                                                    local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]\Field4[local20] = local3\Field1\Field18\Field4[((local94 * $13) + local93)]
                                                    local3\Field1\Field18\Field4[(((local94 + $01) * $13) + local93)]\Field5[local20] = local38
                                                    Exit
                                                EndIf
                                            Next
                                        EndIf
                                    ...
                                    EndIf
                                    If (local93 > $00) Then
                                        If (local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))] <> Null) Then
                                            local38 = entitydistance(local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field0, local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))]\Field0)
                                            For local20 = $00 To $03 Step $01
                                                If (local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))]) Then
                                                    Exit
                                                ElseIf (local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = Null) Then
                                                    local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))]
                                                    local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field5[local20] = local38
                                                    Exit
                                                EndIf
                                            Next
                                            For local20 = $00 To $03 Step $01
                                                If (local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))]\Field4[local20] = local3\Field1\Field18\Field4[((local94 * $13) + local93)]) Then
                                                    Exit
                                                ElseIf (local3\Field1\Field18\Field4[((local94 * $13) + local93)]\Field4[local20] = Null) Then
                                                    local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))]\Field4[local20] = local3\Field1\Field18\Field4[((local94 * $13) + local93)]
                                                    local3\Field1\Field18\Field4[((local93 - $01) + (local94 * $13))]\Field5[local20] = local38
                                                    Exit
                                                EndIf
                                            Next
                                        EndIf
                        ...
                        Next
                        For local20 = $00 To $06 Step $01
                            local3\Field1\Field18\Field2[local20] = local86[local20]
                        Next
                        positionentity(local3\Field1\Field11[$00], (local3\Field1\Field3 + ((Float local101) * 2.0)), entityy(local3\Field1\Field11[$00], $01), (local3\Field1\Field5 + ((Float local103) * 2.0)), $01)
                        positionentity(local3\Field1\Field11[$01], (local3\Field1\Field3 + ((Float local102) * 2.0)), entityy(local3\Field1\Field11[$01], $01), (local3\Field1\Field5 + ((Float local104) * 2.0)), $01)
                    ElseIf (local3\Field1\Field18\Field2[$00] = $00) Then
                                ...
                                If (local3\Field1\Field18\Field0[((local94 * $13) + local93)] > $00) Then
                                    Select local3\Field1\Field18\Field0[((local94 * $13) + local93)]
                                        ...
                                        Case $03,$04
                                            ...
                                            addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.65625), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                        Case $05,$06
                                            local91 = copyentity(local86[$05], $00)
                                            addlight(local3\Field1, (local3\Field1\Field3 + ((Float local93) * 2.0)), ((local3\Field1\Field4 + 8.0) + 1.597656), (local3\Field1\Field5 + ((Float local94) * 2.0)), $02, 0.25, $FF, $C8, $C8, $01)
                                    End Select
                                    scaleentity(local91, (1.0 / 256.0), (1.0 / 256.0), (1.0 / 256.0), $01)
                                    rotateentity(local91, 0.0, ((Float local3\Field1\Field18\Field1[((local94 * $13) + local93)]) * 90.0), 0.0, $00)
                                    positionentity(local91, (local3\Field1\Field3 + ((Float local93) * 2.0)), (local3\Field1\Field4 + 8.0), (local3\Field1\Field5 + ((Float local94) * 2.0)), $01)
                                    local37 = entityyaw(local91, $01)
                                    local45 = sin(local37)
                                    local46 = cos(local37)
                        ...
                        seedrnd(local95)
                    EndIf
                    updatemt(local3\Field1\Field18, mp_getrealcollider())
                            ...
                            For local20 = $00 To $01 Step $01
                                ...
                                For local34 = ((Float local20) * 72.2) To 360.0 Step 1.0
                                    If (((rand($02, $01) = $01) And (local3\Field1\Field18\Field4[(Int local34)] <> Null)) <> 0) Then
                                        local107 = local3\Field1\Field18\Field4[(Int local34)]
                                        local34 = 361.0
                                    EndIf
                                Next
                                If (local107 <> Null) Then
                                    createnpc($0C, entityx(local107\Field0, $01), entityy(local107\Field0, $01), entityz(local107\Field0, $01))
                                EndIf
                            Next
                            local3\Field2 = 1.0
                        EndIf
                    EndIf
                    local3\Field22 = mp_updateelevators(local3\Field22, local3\Field1\Field14[$00], local3\Field1\Field14[$01], local3\Field1\Field11[$02], local3\Field1\Field11[$03], local3, $00, (1.0 = local3\Field2), $00)
                    local3\Field23 = mp_updateelevators(local3\Field23, local3\Field1\Field14[$02], local3\Field1\Field14[$03], local3\Field1\Field11[$04], local3\Field1\Field11[$05], local3, $00, (1.0 = local3\Field2), $00)
                ElseIf (local3\Field1\Field18 <> Null) Then
                    If (local3\Field1\Field18\Field2[$00] <> $00) Then
                        For local94 = $00 To $12 Step $01
                            For local93 = $00 To $12 Step $01
                                If (local3\Field1\Field18\Field3[((local94 * $13) + local93)] <> $00) Then
                                    If (entityhidden(local3\Field1\Field18\Field3[((local94 * $13) + local93)]) = $00) Then
                                        hideentity(local3\Field1\Field18\Field3[((local94 * $13) + local93)])
                                    EndIf
                                EndIf
                            Next
                        Next
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    ElseIf (entityinview(local3\Field1\Field11[$00], camera) = $00) Then
                        ...
                        If (((rand($C8, $01) = $01) And (300.0 < local3\Field2)) <> 0) Then
                            local3\Field6 = playsoundex(loadtempsound("SFX\SCP\Joke\Saxophone.ogg"), camera, local3\Field1\Field11[$00], 6.0, 1.0, $00)
                            local3\Field2 = 0.0
                        EndIf
            ...
            Case $27
                If (5.0 > local3\Field16) Then
                    If (local3\Field1\Field15[$00] = Null) Then
                        ...
                        local3\Field1\Field15[$00]\Field10 = 3.0
                        pointentity(local3\Field1\Field15[$00]\Field3, local3\Field1\Field2, 0.0)
                        setnpcframe(local3\Field1\Field15[$00], 326.0)
                        local108 = (("drawing_1048(" + (Str rand($19, $01))) + ").png")
                        For local19 = Each itemtemplates
                            If (local19\Field1 = "Drawing") Then
                                If (local19\Field11 <> $00) Then
                                    ...
                                    local19\Field11 = $00
                                EndIf
                                local19\Field10 = ("GFX\Items\HUD Textures\" + local108)
                            ...
                            EndIf
                        Next
                        local109 = getrescaledtexture(("GFX\Items\HUD Textures\" + local108), $01, $100, $100, $01)
            ...
            Case $20
                If (local3\Field8 = $00) Then
                    If (event_isplayerinroom(local3) <> 0) Then
                        ...
                        local3\Field6 = playsoundex(local3\Field8, camera, n_i\Field4\Field0, 10.0, 1.0, $01)
                ...
                ElseIf (3150.0 > local3\Field2) Then
                    If (((rand($32, $01) = $01) And event_isplayerinroom(local3)) <> 0) Then
                        ...
                        If (rand($05, $01) = $01) Then
                            playsoundex(snd_i\Field33[rand($00, $02)], camera, local3\Field1\Field2, 8.0, rnd(0.1, 0.3), $00)
                        EndIf
                    EndIf
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (730.0 < tformedx()) Then
                        ...
                        For local20 = $01 To $02 Step $01
                            ...
                            local111 = local3\Field1\Field14[local20]
                            local111\Field6 = local110\Field6
                            local111\Field8 = local110\Field8
                            entityparent(local111\Field0, local111\Field2, $01)
                            entityparent(local110\Field0, local110\Field2, $01)
                            entityparent(local111\Field1, local111\Field2, $01)
                            entityparent(local110\Field1, local110\Field2, $01)
                            positionentity(local111\Field0, entityx(local110\Field0, $00), entityy(local110\Field0, $00), entityz(local110\Field0, $00), $00)
                            positionentity(local111\Field1, entityx(local110\Field1, $00), entityy(local110\Field1, $00), entityz(local110\Field1, $00), $00)
                            entityparent(local111\Field0, $00, $01)
                            entityparent(local110\Field0, $00, $01)
                            entityparent(local111\Field1, $00, $01)
                    ...
                    ElseIf (-730.0 > tformedx()) Then
                        ...
                        For local20 = $01 To $02 Step $01
                            ...
                            local111 = local3\Field1\Field14[(local20 + $02)]
                            local111\Field6 = local110\Field6
                            local111\Field8 = local110\Field8
                            entityparent(local111\Field0, local111\Field2, $01)
                            entityparent(local110\Field0, local110\Field2, $01)
                    ...
                    If (local23 <> 0) Then
                        ...
                        Select local3\Field2
                            ...
                            Case 25.0
                                ...
                                setnpcframe(local3\Field1\Field15[$00], 80.0)
                                local3\Field1\Field15[$00]\Field87 = $01
                            Case 30.0
                                local20 = rand($00, (maxitemamount - $01))
                                If (inventory(local20) <> Null) Then
                            ...
                            Case 50.0
                                ...
                                local3\Field1\Field15[$01]\Field87 = $01
                            Case 52.0
                                removenpc(local3\Field1\Field15[$01])
                            Case 60.0
            ...
            Case $12
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (local3\Field1\Field15[$00] = Null) Then
                        ...
                        setnpcframe(local3\Field1\Field15[$04], 40.0)
                        ...
                        setnpcframe(local3\Field1\Field15[$05], 19.0)
                        ...
                        If (local3\Field1\Field14[$04]\Field6 = $00) Then
                            For local20 = $00 To $01 Step $01
                                If (updatelever(local3\Field1\Field13[local20]\Field0, $00, $50, -80.0) <> 0) Then
                                    ...
                                    local3\Field7 = playsoundex(local3\Field9, camera, local3\Field1\Field14[$04]\Field0, 400.0, 1.0, $00)
                                    Exit
                                EndIf
                            Next
                        Else
            ...
            Case $15
                If (event_isplayerinroom(local3) <> 0) Then
                    If (0.0 = local3\Field2) Then
                        ...
                        changenpctextureid(local3\Field1\Field15[$00], $0C)
                        setnpcframe(local3\Field1\Field15[$00], 501.0)
                        rotateentity(local3\Field1\Field15[$00]\Field3, 0.0, ((Float local3\Field1\Field6) + 270.0), 0.0, $01)
                        local3\Field2 = 1.0
                                    ...
                                    If (-2100.0 < local3\Field4) Then
                                        ...
                                        ElseIf (((1050.0 < local3\Field4) And (1750.0 > local3\Field4)) <> 0) Then
                                            If (1050.0 >= (local3\Field4 - fps\Field7[$00])) Then
                                                ...
                                                local3\Field1\Field15[$00]\Field18 = playsound_strict(local3\Field1\Field15[$00]\Field17, $01)
                                                setnpcframe(local3\Field1\Field15[$00], 553.0)
                                            EndIf
                                            local3\Field1\Field15[$00]\Field10 = 6.0
            ...
            Case $1C
                If (event_isplayerinroom(local3) <> 0) Then
                    playsoundex(snd_i\Field25, camera, local3\Field1\Field2, 10.0, 1.0, $00)
                            ...
                            ElseIf (1.96 < local38) Then
                                If (((840.0 < local3\Field2) And (mp_somebodysees173(n_i\Field2) = $00)) <> 0) Then
                                    ...
                                    Else
                                        ...
                                        entityparent(local5\Field0, local3\Field1\Field2, $01)
                                        playsoundex(loadtempsound("SFX\Room\GlassBreak.ogg"), camera, n_i\Field2\Field0, 10.0, 1.0, $00)
                                        hideentity(local3\Field1\Field11[$02])
                    ...
                    If (0.0 < local3\Field2) Then
                        ...
                        If (200.0 < local3\Field2) Then
                            If (local3\Field1\Field15[$00] = Null) Then
                                ...
                                setnpcframe(local3\Field1\Field15[$00], 1.0)
                                If (event_ismeinroom(local3) <> 0) Then
                                    playsound_strict(snd_i\Field47[$00], $00)
                            ...
                            Else
                                ...
                                If (local3\Field8 = $00) Then
                                    loadeventsound(local3, "SFX\Character\BodyFall.ogg", $00)
                                    playsoundex(local3\Field8, camera, local3\Field1\Field15[$00]\Field3, 10.0, 1.0, $00)
            ...
            Case $0A
                If (6.0 > local3\Field16) Then
                    If (local3\Field1\Field15[$00] = Null) Then
                        ...
                        local3\Field1\Field15[$00]\Field10 = 8.0
                        local3\Field1\Field15[$00]\Field50 = $01
                        setnpcframe(local3\Field1\Field15[$00], 288.0)
                ...
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (25.0 > entitydistancesquared(me\Field60, local3\Field1\Field11[$00])) Then
                        If (rand($32, $01) = $01) Then
                            ...
                            playsoundex(snd_i\Field62, camera, local3\Field1\Field11[$00], 3.0, 0.4, $00)
                        EndIf
                    EndIf
                EndIf
            Case $44
                local113 = (local3\Field1\Field11[$01] <> $00)
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (local3\Field8 = $00) Then
                        If ((((0.64 > entitydistancesquared(local3\Field1\Field11[$00], me\Field60)) And (0.0 = local3\Field3)) And (1.0 = local3\Field4)) <> 0) Then
                            If (local113 <> 0) Then
                                ...
                                local3\Field7 = playsoundex(local3\Field9, camera, local3\Field1\Field11[$01], 5.0, 1.0, $00)
                            EndIf
                            stopchannel(local3\Field6)
                            local3\Field6 = $00
                    ...
                    ElseIf (630.0 > local3\Field2) Then
                        ...
                        ElseIf (((210.0 < local3\Field2) And (490.0 > local3\Field2)) <> 0) Then
                            ...
                            Next
                            If (channelplaying(local3\Field6) = $00) Then
                                local3\Field6 = playsoundex(local3\Field8, camera, local3\Field1\Field11[$00], 5.0, 1.0, $00)
                            EndIf
                        EndIf
                    Else
                        For local20 = $00 To $01 Step $01
                    ...
                    ElseIf (0.0 = local3\Field3) Then
                        ...
                        For local20 = $00 To $03 Step $01
                            If (local3\Field1\Field20[local20] <> Null) Then
                                If (local116 = $FFFFFFFF) Then
                                    local114 = entitydistancesquared(local3\Field1\Field11[$07], local3\Field1\Field20[local20]\Field2)
                                    local116 = local20
                                Else
                                    local115 = entitydistancesquared(local3\Field1\Field11[$07], local3\Field1\Field20[local20]\Field2)
                                    local117 = local20
                                EndIf
                            EndIf
                        Next
                        If (n_i\Field6 = Null) Then
                            If (local115 < local114) Then
                            ...
                            Else
                                n_i\Field6 = createnpc($02, entityx(local3\Field1\Field20[local117]\Field2, $00), entityy(local3\Field1\Field11[$07], $01), entityz(local3\Field1\Field20[local117]\Field2, $00))
                            EndIf
                            giveachievement("049", $01)
                        Else
                            If (local115 < local114) Then
                            ...
                            Else
                                positionentity(n_i\Field6\Field3, entityx(local3\Field1\Field20[local117]\Field2, $00), entityy(local3\Field1\Field11[$07], $01), entityz(local3\Field1\Field20[local117]\Field2, $00), $01)
                            EndIf
                    ...
                    ElseIf (2.0 = local3\Field3) Then
                        ...
                        ElseIf (25.0 > entitydistancesquared(local3\Field1\Field15[$00]\Field3, local3\Field1\Field14[$00]\Field2)) Then
                            ...
                            If (0.0 = local3\Field1\Field15[$00]\Field28) Then
                                playsoundex(snd_i\Field4, camera, local3\Field1\Field14[$01]\Field2, 7.0, 1.0, $00)
                                local3\Field1\Field15[$00]\Field7 = 0.0
                            ...
                            If (0.0 = local3\Field1\Field15[$00]\Field41) Then
                                If (local3\Field1\Field15[$00]\Field13 = $01) Then
                                    If (local3\Field1\Field15[$00]\Field20 = $00) Then
                                        ...
                                        local3\Field1\Field15[$00]\Field20 = playsoundex(local3\Field1\Field15[$00]\Field19, camera, local3\Field1\Field15[$00]\Field3, 10.0, 1.0, $01)
            ...
            Case $3C
                If (hidedistance > local3\Field16) Then
                    ...
                    EndIf
                    If (0.0 = local3\Field2) Then
                        local120 = local3\Field1\Field7\Field6
                        Select local120
                            Case $3E,$3F,$40,$43,$44
                                If (((local120 = $43) Lor (local120 = $44)) <> 0) Then
                                    local119 = rand($00, $03)
                                Else
                                    local119 = rand($00, $02)
                                EndIf
            ...
            Case $21
                If (local3\Field1\Field15[$00] = Null) Then
                    ...
                    local3\Field1\Field15[$00]\Field10 = 8.0
                    local3\Field1\Field15[$00]\Field50 = $01
                    setnpcframe(local3\Field1\Field15[$00], 286.0)
                    rotateentity(local3\Field1\Field15[$00]\Field3, 0.0, ((Float local3\Field1\Field6) + 180.0), 0.0, $01)
                EndIf
                If (event_isplayerinroom(local3) <> 0) Then
                    ...
                    If (((d_i\Field9 = local3\Field1\Field11[$01]) And mo\Field0) <> 0) Then
                        ...
                        playsoundex(buttonsfx[$01], camera, local3\Field1\Field11[$01], 10.0, 1.0, $00)
                        mo\Field0 = $00
                    EndIf
                EndIf
            Case $14
                                ...
                                If (local3\Field1\Field15[$05]\Field17 = $00) Then
                                    If (1.0 > (Abs (entityy(me\Field60, $00) - entityy(local3\Field1\Field11[$0B], $01)))) Then
                                        If (144.0 > distancesquared(entityx(me\Field60, $00), entityx(local3\Field1\Field11[$0B], $01), entityz(me\Field60, $00), entityz(local3\Field1\Field11[$0B], $01), 0.0, 0.0)) Then
                                            ...
                                            playsoundex(local3\Field1\Field15[$05]\Field17, camera, local3\Field1\Field15[$05]\Field3, 25.0, 1.0, $01)
                                            local3\Field1\Field14[$00]\Field6 = $01
                                            For local20 = $02 To $04 Step $01
                                                local3\Field1\Field15[local20]\Field10 = 0.0
                                            Next
                                ...
                                ElseIf (local3\Field1\Field11[$0C] = $00) Then
                                    ...
                                    If (1.0 > (Abs (entityy(me\Field60, $00) - entityy(local3\Field1\Field11[$0B], $01)))) Then
                                        If (49.0 > distancesquared(entityx(me\Field60, $00), entityx(local3\Field1\Field11[$0B], $01), entityz(me\Field60, $00), entityz(local3\Field1\Field11[$0B], $01), 0.0, 0.0)) Then
                                            ...
                                            local123 = (0.55 / meshwidth(local3\Field1\Field11[$0C]))
                                            scaleentity(local3\Field1\Field11[$0C], local123, local123, local123, $00)
                                            ...
                                            local124 = copyentity(local3\Field1\Field11[$0C], $00)
                                            positionentity(local124, (entityx(local3\Field1\Field2, $01) - 16.25), entityy(local3\Field1\Field11[$0B], $01), (entityz(local3\Field1\Field2, $01) - 7.5), $00)
                                            entityparent(local124, local3\Field1\Field11[$11], $01)
                                            local124 = copyentity(local3\Field1\Field11[$0C], $00)
                                            positionentity(local124, (entityx(local3\Field1\Field2, $01) - 15.875), entityy(local3\Field1\Field11[$0B], $01), (entityz(local3\Field1\Field2, $01) - 8.25), $00)
                                            entityparent(local124, local3\Field1\Field11[$11], $01)
                                            local3\Field6 = playsoundex(loadtempsound("SFX\Ending\GateA\Bell0.ogg"), camera, local3\Field1\Field11[$0C], 10.0, 1.0, $00)
