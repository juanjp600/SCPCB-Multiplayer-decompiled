Function rendergui%()
    ...
    If (((selecteddifficulty\Field0 <> difficulties[$03]\Field0) And opt\Field32) <> 0) Then
        ...
        EndIf
        local25 = renderhud()
        mp_renderchathud((30.0 * menuscale), (Float local25))
    EndIf
    ...
    If (d_i\Field6 <> Null) Then
        ...
        EndIf
        If (local28 <> 0) Then
            local29 = entityx(d_i\Field9, $01)
            local30 = entityy(d_i\Field9, $01)
            local31 = entityz(d_i\Field9, $01)
            camerazoom(camera, (min(((me\Field52 / 400.0) + 1.0), 1.1) / camerazoomvalue))
            local19 = createpivot($00)
            positionentity(local19, local29, local30, local31, $00)
            ...
            cameraproject(camera, local29, (local30 + local18), local31)
            local17 = projectedy()
            cameraproject(camera, local29, (local30 - local18), local31)
            local18 = ((projectedy() - local17) / (462.0 * menuscale))
            local32 = (local18 / 2.0)
            local4 = (Int ((Float mo\Field9) - ((Float imagewidth(t\Field1[$04])) * local32)))
            local5 = (Int ((Float mo\Field10) - ((Float imageheight(t\Field1[$04])) * local32)))
        ...
        EndIf
    EndIf
    local36 = (Int (70.0 * menuscale))
    local37 = (Int (35.0 * menuscale))
    local38 = (Int ((64.0 * menuscale) / 2.0))
    local39 = (maxitemamount Sar $01)
    If (otheropen <> Null) Then
        local33 = otheropen
        local40 = otheropen\Field20
        For local7 = $00 To (local40 - $01) Step $01
            If (otheropen\Field18[local7] <> Null) Then
                local41 = (local41 + $01)
            EndIf
        Next
        local42 = $00
        local4 = (mo\Field9 - ((((local36 * $0A) Sar $01) + (local37 Shl $02)) Sar $01))
        local5 = ((mo\Field10 - ((((local40 / $0A) Shl $01) - $01) * local36)) - local37)
        local34 = $FFFFFFFF
        For local20 = $00 To (local40 - $01) Step $01
            If (mouseon(local4, local5, local36, local36) <> 0) Then
                local34 = local20
            EndIf
            If (local34 = local20) Then
                local27 = local20
                color($FF, $00, $00)
                rect((local4 - $01), (local5 - $01), (Int ((2.0 * menuscale) + (Float local36))), (Int ((2.0 * menuscale) + (Float local36))), $01)
            EndIf
            renderframe(local4, local5, local36, local36, (local4 Mod $40), (local4 Mod $40), $00)
            If (otheropen = Null) Then
                Exit
            EndIf
            If (otheropen\Field18[local20] <> Null) Then
                If (((local34 = local20) Lor (selecteditem <> otheropen\Field18[local20])) <> 0) Then
                    drawblock(otheropen\Field18[local20]\Field17, (Int ((Float ((local36 Sar $01) + local4)) - (32.0 * menuscale))), (Int ((Float ((local36 Sar $01) + local5)) - (32.0 * menuscale))), $00)
                EndIf
            EndIf
            If (((otheropen\Field18[local20] <> Null) And (selecteditem <> otheropen\Field18[local20])) <> 0) Then
                If (local34 = local20) Then
                    ...
                    color($FF, $FF, $FF)
                    textex(((local36 Sar $01) + local4), (Int ((Float ((local5 + local36) + local37)) - (15.0 * menuscale))), otheropen\Field18[local20]\Field4\Field0, $01, $00)
                EndIf
            EndIf
            local4 = ((local4 + local36) + local37)
            local42 = (local42 + $01)
            If (local42 = $05) Then
                local42 = $00
                local5 = (local5 + (local36 Shl $01))
                local4 = (mo\Field9 - ((((local36 * $0A) Sar $01) + (local37 Shl $02)) Sar $01))
            EndIf
        Next
        If (selecteditem <> Null) Then
            If (mo\Field2 <> 0) Then
                If (((local27 = $42) Lor (selecteditem <> local33\Field18[local27])) <> 0) Then
                    drawblock(selecteditem\Field17, (Int (mouseposx - (Float local38))), (Int (mouseposy - (Float local38))), $00)
                EndIf
            EndIf
        EndIf
        rendercursor()
    ElseIf (invopen <> 0) Then
        local4 = (mo\Field9 - (((local36 * local39) + ((local39 - $01) * local37)) Sar $01))
        local5 = ((mo\Field10 - local36) - local37)
        If (maxitemamount = $02) Then
            local5 = (local5 + local36)
            local4 = (local4 - (((local36 * local39) + local37) Sar $01))
        EndIf
        local34 = $FFFFFFFF
        For local20 = $00 To (maxitemamount - $01) Step $01
            ...
            If (inventory(local20) <> Null) Then
                ...
                Select inventory(local20)\Field4\Field2
                    Case $38
                        local43 = (wi\Field0 = $01)
                    Case $39
                        local43 = (wi\Field0 = $02)
                    Case $3A
                        local43 = (wi\Field0 = $03)
                    Case $3B
                        local43 = (wi\Field0 = $04)
                    Case $24
                        local43 = (i_1499\Field0 = $01)
                    Case $25
                        local43 = (i_1499\Field0 = $02)
                    Case $40
                        local43 = (wi\Field5 = $01)
                    Case $41
                        local43 = (wi\Field5 = $02)
                    Case $42
                        local43 = (wi\Field5 = $03)
                    Case $43
                        local43 = (wi\Field9 = $01)
                    Case $44
                        local43 = (wi\Field9 = $02)
                    Case $26
                        local43 = wi\Field4
                    Case $0D
                        local43 = (i_268\Field0 = $01)
                    Case $0E
                        local43 = (i_268\Field0 = $02)
                    Case $0F
                        local43 = (i_268\Field0 = $03)
                    Case $27
                        local43 = (wi\Field3 = $01)
                    Case $28
                        local43 = (wi\Field3 = $02)
                    Case $3C
                        local43 = (wi\Field2 = $01)
                    Case $3D
                        local43 = (wi\Field2 = $02)
                    Case $3E
                        local43 = (wi\Field2 = $03)
                    Case $3F
                        local43 = (wi\Field2 = $04)
                    Case $14
                        local43 = i_427\Field0
                    Case $1B
                        local43 = (i_714\Field0 = $02)
                    Case $1A
                        local43 = (i_714\Field0 = $01)
                    Default
                        local43 = $00
                End Select
                If (local43 <> 0) Then
                    rect((Int ((Float local4) - (3.0 * menuscale))), (Int ((Float local5) - (3.0 * menuscale))), (Int ((6.0 * menuscale) + (Float local36))), (Int ((6.0 * menuscale) + (Float local36))), $01)
                EndIf
            EndIf
            If (0.0 < i_1025\Field1[$00]) Then
                If (((local20 = (maxitemamount - $01)) Lor (local20 = (local39 - $01))) <> 0) Then
                    color($00, $FF, $00)
                    rect((local4 - $01), (local5 - $01), (Int ((2.0 * menuscale) + (Float local36))), (Int ((2.0 * menuscale) + (Float local36))), $01)
                EndIf
            EndIf
            ...
            renderframe(local4, local5, local36, local36, (local4 Mod $40), (local4 Mod $40), $00)
            If (inventory(local20) <> Null) Then
                If (((local34 = local20) Lor (selecteditem <> inventory(local20))) <> 0) Then
                    drawblock(inventory(local20)\Field17, (Int ((Float ((local36 Sar $01) + local4)) - (32.0 * menuscale))), (Int ((Float ((local36 Sar $01) + local5)) - (32.0 * menuscale))), $00)
                EndIf
            EndIf
            If (((inventory(local20) <> Null) And (selecteditem <> inventory(local20))) <> 0) Then
                If (local34 = local20) Then
                    If (selecteditem = Null) Then
                        setfontex(fo\Field0[$00])
                        color($FF, $FF, $FF)
                        textex(((local36 Sar $01) + local4), (Int ((Float ((local5 + local36) + local37)) - (15.0 * menuscale))), inventory(local20)\Field0, $01, $00)
                    EndIf
                EndIf
            EndIf
            local4 = ((local4 + local36) + local37)
            If (((maxitemamount >= $04) And (local20 = (local39 - $01))) <> 0) Then
                local5 = (local5 + (local36 Shl $01))
                local4 = (mo\Field9 - (((local36 * local39) + ((local39 - $01) * local37)) Sar $01))
            EndIf
        Next
        If (selecteditem <> Null) Then
            If (mo\Field2 <> 0) Then
                If (((local27 = $42) Lor (selecteditem <> inventory(local27))) <> 0) Then
                    drawblock(selecteditem\Field17, (Int (mouseposx - (Float local38))), (Int (mouseposy - (Float local38))), $00)
                EndIf
            EndIf
        EndIf
    ...
    ElseIf (selecteditem <> Null) Then
        local45 = (Int (300.0 * menuscale))
        local46 = (Int (20.0 * menuscale))
        Select selecteditem\Field4\Field2
                ...
                If (preventitemoverlapping($01, $00, $00, $01, $00, $00, $01) = $00) Then
                    Select selecteditem\Field4\Field2
                        ...
                        Case $3B
                            ...
                            EndIf
                    End Select
                    drawblock(selecteditem\Field4\Field7, (mo\Field9 - local38), (mo\Field10 - local38), $00)
                    local4 = (mo\Field9 - (local45 Sar $01))
                    local5 = (Int ((Float mo\Field10) + (80.0 * menuscale)))
                    renderbar(blinkmeterimg, local4, local5, local45, local46, selecteditem\Field12, 100.0, $64, $64, $64)
                EndIf
            Case $24,$25
            ...
            Case $40,$41,$42
                If (preventitemoverlapping($00, $01, $00, $01, $00, $00, $01) = $00) Then
                    ...
                    local4 = (mo\Field9 - (local45 Sar $01))
                    local5 = (Int ((Float mo\Field10) + (80.0 * menuscale)))
                    renderbar(blinkmeterimg, local4, local5, local45, local46, selecteditem\Field14, 100.0, $64, $64, $64)
                EndIf
            Case $43,$44
            ...
            Case $49,$4A,$4B,$4C
                If (((selecteditem\Field4\Field11 <> $00) And (-6.0 < me\Field10)) <> 0) Then
                    ...
                    setfontex(fo\Field0[$02])
                    local54 = ((selecteditem\Field4\Field2 = $4A) Lor (selecteditem\Field4\Field2 = $49))
                    local55 = (Int (287.0 * menuscale))
                    local56 = (Int (256.0 * menuscale))
                    local57 = (Int (24.0 * menuscale))
                    local58 = (local57 Sar $01)
                    local59 = (local55 Sar $01)
                    local60 = (local56 Sar $01)
                    If (((playerinreachableroom($01, $00) = $00) Lor (infacility <> $00)) <> 0) Then
                        If ((millisec Mod $320) < $C8) Then
                            color($C8, $00, $00)
                            textex(local4, (Int ((Float (local5 + local60)) - (80.0 * menuscale))), getlocalstring("msg", "nav.error"), $01, $00)
                            textex(local4, (Int ((Float (local5 + local60)) - (60.0 * menuscale))), getlocalstring("msg", "nav.locunknown"), $01, $00)
                        EndIf
                    ElseIf (((((0.0 < selecteditem\Field12) Lor (selecteditem\Field4\Field2 = $4A)) Lor (selecteditem\Field4\Field2 = $4C)) And ((16.0 < coffindistance) Lor (coffindistance > rnd(16.0, 0.0)))) <> 0) Then
                        local61 = (local4 - selecteditem\Field4\Field13)
                        local62 = (Int ((Float (local5 - selecteditem\Field4\Field14)) + (85.0 * menuscale)))
                        If (0.0 = selecteditem\Field13) Then
                            local63 = entityx(me\Field60, $00)
                            local64 = entityz(me\Field60, $00)
                            local65 = (Int floor(((local63 / 8.0) + 0.5)))
                            local66 = (Int floor(((local64 / 8.0) + 0.5)))
                            setbuffer(imagebuffer(t\Field1[$07], $00))
                            drawimage(selecteditem\Field4\Field11, local61, local62, $00)
                            local4 = (Int ((((local63 - 4.0) Mod 8.0) * (3.0 * menuscale)) + ((Float local4) - (12.0 * menuscale))))
                            local5 = (Int (((12.0 * menuscale) + (Float local5)) - (((local64 - 4.0) Mod 8.0) * (3.0 * menuscale))))
                            local67 = (Int max(1.0, (Float (local65 - $06))))
                            local68 = (Int min(20.0, (Float (local65 + $06))))
                            local69 = (Int max(1.0, (Float (local66 - $06))))
                            local70 = (Int min(20.0, (Float (local66 + $06))))
                            For local11 = (Float local67) To (Float local68) Step 1.0
                                For local16 = (Float local69) To (Float local70) Step 1.0
                                    If (((currmapgrid\Field0[(Int ((local16 * 21.0) + local11))] > $00) And ((currmapgrid\Field2[(Int ((local16 * 21.0) + local11))] > $00) Lor (local54 = $00))) <> 0) Then
                                        local71 = (Int ((((Float local65) - local11) * (Float local57)) + (Float local4)))
                                        local72 = (Int ((Float local5) - (((Float local66) - local16) * (Float local57))))
                                        ...
                                        If (currmapgrid\Field0[(Int ((local11 + 1.0) + (local16 * 21.0)))] = $00) Then
                                            rect((local71 - local58), (local72 - local58), $01, local57, $01)
                                        EndIf
                                        If (currmapgrid\Field0[(Int ((local11 - 1.0) + (local16 * 21.0)))] = $00) Then
                                            rect((local71 + local58), (local72 - local58), $01, local57, $01)
                                        EndIf
                                        If (currmapgrid\Field0[(Int (((local16 - 1.0) * 21.0) + local11))] = $00) Then
                                            rect((local71 - local58), (local72 - local58), local57, $01, $01)
                                        EndIf
                                        If (currmapgrid\Field0[(Int (((local16 + 1.0) * 21.0) + local11))] = $00) Then
                                            rect((local71 - local58), (local72 + local58), local57, $01, $01)
                                        EndIf
                        ...
                        EndIf
                        drawblockrect(t\Field1[$07], (Int ((80.0 * menuscale) + (Float local61))), (Int ((70.0 * menuscale) + (Float local62))), (Int ((80.0 * menuscale) + (Float local61))), (Int ((70.0 * menuscale) + (Float local62))), (Int (270.0 * menuscale)), (Int (230.0 * menuscale)), $00)
                        color((($AA * local54) + $1E), ($1E * local54), ($1E * local54))
                        rect((Int ((80.0 * menuscale) + (Float local61))), (Int ((70.0 * menuscale) + (Float local62))), (Int (270.0 * menuscale)), (Int (230.0 * menuscale)), $00)
                        local4 = (Int ((Float (opt\Field46 - selecteditem\Field4\Field13)) + (20.0 * menuscale)))
                        local5 = (Int ((Float (opt\Field47 - selecteditem\Field4\Field14)) - (85.0 * menuscale)))
                        color((($AA * local54) + $1E), ($1E * local54), ($1E * local54))
                        If ((millisec Mod $320) < $C8) Then
                            If (local54 <> 0) Then
                                textex((Int ((10.0 * menuscale) + (Float (local4 - local59)))), (Int ((10.0 * menuscale) + (Float (local5 - local60)))), getlocalstring("msg", "nav.data"), $00, $00)
                            EndIf
                        ...
                        If (selecteditem\Field4\Field2 = $4C) Then
                            local77 = $00
                            local78 = $00
                            For local76 = Each rooms
                                local79 = local76\Field7\Field6
                                If ((((((local79 <> $04) And (local79 <> $47)) And (local79 <> $49)) And (local79 <> $69)) And (local79 <> $6A)) <> 0) Then
                                    local77 = (local77 + $01)
                                    local78 = (local78 + local76\Field1)
                                EndIf
                            Next
                            textex((Int ((10.0 * menuscale) + (Float (local4 - local59)))), (Int ((10.0 * menuscale) + (Float (local5 - local60)))), (((Str local78) + "/") + (Str local77)), $00, $00)
                            If ((millisec Mod $258) < $190) Then
                                color($C8, $00, $00)
                                For local75 = Each npcs
                                    If ((((((local75\Field4 = $07) Lor (local75\Field4 = $06)) Lor (local75\Field4 = $05)) Lor (local75\Field4 = $02)) Lor (local75\Field4 = $04)) <> 0) Then
                                        If (local75\Field43 = $00) Then
                                            local74 = entitydistancesquared(camera, local75\Field3)
                                            If (900.0 > local74) Then
                                                local24 = sqr(local74)
                                                ...
                                                textex((Int ((10.0 * menuscale) + (Float (local4 - local59)))), (Int (((30.0 * menuscale) + (Float (local5 - local60))) + ((Float ($14 * local73)) * menuscale))), local75\Field47, $00, $00)
                                                local73 = (local73 + $01)
                                            EndIf
                                        EndIf
                                    EndIf
                                ...
                                If (playerroom\Field7\Field6 = $2C) Then
                                    If (8.0 > coffindistance) Then
                                        local74 = rnd(4.0, 8.0)
                                        oval((Int ((Float local4) - ((1.5 * menuscale) * local74))), (Int ((Float local5) - ((1.5 * menuscale) * local74))), (Int ((3.0 * menuscale) * local74)), (Int ((3.0 * menuscale) * local74)), $00)
                                        textex((Int ((10.0 * menuscale) + (Float (local4 - local59)))), (Int (((30.0 * menuscale) + (Float (local5 - local60))) + ((Float ($14 * local73)) * menuscale))), "SCP-895", $00, $00)
                                    EndIf
                                EndIf
                            EndIf
                        EndIf
                        If (((0.0 < selecteditem\Field12) And ((selecteditem\Field4\Field2 = $49) Lor (selecteditem\Field4\Field2 = $4B))) <> 0) Then
                            local21 = (Int ((196.0 * menuscale) + (Float (local4 - local59))))
                            local22 = (Int ((10.0 * menuscale) + (Float (local5 - local60))))
