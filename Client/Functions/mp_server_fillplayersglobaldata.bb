Function mp_server_fillplayersglobaldata%()
    ...
    For local1 = Each mp_modelmesh
        If (local1\Field3 = $00) Then
            ...
            mp_writeshort(convertfloattoshort(local1\Field4\Field8, 10.0))
            ...
            mp_writefloat(local1\Field4\Field10)
            mp_writeshort(convertfloattoshort(local1\Field4\Field13, 10.0))
            mp_writeshort(convertfloattoshort(local1\Field4\Field14, 10.0))
            mp_writeshort(convertfloattoshort(local1\Field4\Field15, 10.0))
            mp_writefloat(local1\Field4\Field16)
            mp_writefloat(local1\Field4\Field17)
            mp_writefloat(local1\Field4\Field18)
            mp_writeshort(convertfloattoshort(local1\Field4\Field19, 10.0))
            mp_writeshort(convertfloattoshort(local1\Field4\Field20, 10.0))
            mp_writeshort(convertfloattoshort(local1\Field4\Field21, 10.0))
            mp_writeline(local1\Field4\Field12)
            For local0 = $01 To $13 Step $01
                If (local1\Field4\Field22[local0] <> $00) Then
                    mp_writebyte(local0)
                    mp_writeint(local1\Field4\Field22[local0])
                    mp_writefloat(local1\Field4\Field23[local0])
                    mp_writefloat(local1\Field4\Field24[local0])
                EndIf
            Next
            mp_writebyte($00)
            For local0 = $00 To $03 Step $01
                mp_writeint(local1\Field4\Field25[local0])
                mp_writefloat(local1\Field4\Field26[local0])
            Next
            For local0 = $00 To $03 Step $01
                mp_writeline(local1\Field4\Field28[local0])
            Next
        EndIf
    Next
    mp_writebyte($00)
