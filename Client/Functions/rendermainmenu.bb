        ...
        If (mm\Field5 < $07) Then
            Select mm\Field5
                ...
                Case $02
                    ...
                    setfontex(fo\Field0[$00])
                    color($FF, $FF, $FF)
                    textex((Int ((20.0 * menuscale) + (Float local0))), (Int ((25.0 * menuscale) + (Float local1))), format(getlocalstring("menu", "new.seed2"), "", "%s"), $00, $00)
                    textex((Int ((20.0 * menuscale) + (Float local0))), (Int ((65.0 * menuscale) + (Float local1))), getlocalstring("mpmenu", "serverport"), $00, $00)
