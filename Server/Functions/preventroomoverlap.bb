Function preventroomoverlap%(arg0.rooms)
    ...
    EndIf
    local2 = $00
    If ((((arg0\Field7\Field10 = "checkpoint1") Or (arg0\Field7\Field10 = "checkpoint2")) Or (arg0\Field7\Field10 = "start")) <> 0) Then
        Return $01
    EndIf
    For local0 = Each rooms
        If (((local0 <> arg0) And (local0\Field7\Field18 = $00)) <> 0) Then
    ...
    EndIf
    If (local2 = $00) Then
        debuglog(("ROOM2 turning succesful! " + arg0\Field7\Field10))
        Return $01
    EndIf
    local2 = $01
    For local0 = Each rooms
        If (((local0 <> arg0) And (local0\Field7\Field18 = $00)) <> 0) Then
            If ((((arg0\Field7\Field9 = local0\Field7\Field9) And (arg0\Field0 = local0\Field0)) And (((local0\Field7\Field10 <> "checkpoint1") And (local0\Field7\Field10 <> "checkpoint2")) And (local0\Field7\Field10 <> "start"))) <> 0) Then
                local3 = (Int (arg0\Field3 / 8.0))
                local4 = (Int (arg0\Field5 / 8.0))
                local8 = arg0\Field6
                ...
                For local1 = Each rooms
                    If (local1\Field7\Field18 = $00) Then
                        If (local1 <> arg0) Then
    ...
    Next
    If (local2 = $00) Then
        debuglog(("Room re-placing successful! " + arg0\Field7\Field10))
        Return $01
    EndIf
    debuglog(("Couldn't fix overlap issue for room " + arg0\Field7\Field10))
    Return $00
    Return $00
End Function
