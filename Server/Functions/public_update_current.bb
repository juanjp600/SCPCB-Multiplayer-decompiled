Function public_update_current%(arg0.scriptsthread, arg1%)
    Local local0%
    Local local1%
    Local local2$[16]
    Local local3%[16]
    ...
    If (arg0\Field3 <> $00) Then
        public_update_lua(arg0\Field3, public_getname(publics\Field0))
        Return $00
    EndIf
    ...
    Next
    local5 = arg0\Field0\Field8[publics\Field0]
    If (local5 <> Null) Then
