Function loadmap%(arg0$)
    ...
    If (right(arg0, $06) = "cbmap2") Then
        ...
        For local6 = Each rooms
            If (local6\Field7\Field10 = "room860") Then
                local13 = local6
                Exit
            EndIf
        Next
            ...
            If (local16 <> Null) Then
                Select local3
                    Case "maintenance tunnel endroom"
                        local16\Field31\Field0[((local2 * $13) + local1)] = $01
                    Case "maintenance tunnel corridor"
                        local16\Field31\Field0[((local2 * $13) + local1)] = $02
                    Case "maintenance tunnel corner"
                        local16\Field31\Field0[((local2 * $13) + local1)] = $03
                    Case "maintenance tunnel t-shaped room"
                        local16\Field31\Field0[((local2 * $13) + local1)] = $04
                    Case "maintenance tunnel 4-way room"
                        local16\Field31\Field0[((local2 * $13) + local1)] = $05
                    Case "maintenance tunnel elevator"
                        local16\Field31\Field0[((local2 * $13) + local1)] = $06
    ...
    For local6 = Each rooms
        local6\Field32[$00] = Null
        local6\Field32[$01] = Null
        local6\Field32[$02] = Null
        local6\Field32[$03] = Null
        For local25 = Each rooms
            If (local6 <> local25) Then
                If (local6\Field5 = local25\Field5) Then
                    If ((local6\Field3 + 8.0) = local25\Field3) Then
                        local6\Field32[$00] = local25
                        If (local6\Field33[$00] = Null) Then
                            local6\Field33[$00] = local25\Field33[$02]
                        EndIf
                    ElseIf ((local6\Field3 - 8.0) = local25\Field3) Then
                        local6\Field32[$02] = local25
                        If (local6\Field33[$02] = Null) Then
                            local6\Field33[$02] = local25\Field33[$00]
                        EndIf
                    EndIf
                ElseIf (local6\Field3 = local25\Field3) Then
                    If ((local6\Field5 - 8.0) = local25\Field5) Then
                        local6\Field32[$01] = local25
                        If (local6\Field33[$01] = Null) Then
                            local6\Field33[$01] = local25\Field33[$03]
                        EndIf
                    ElseIf ((local6\Field5 + 8.0) = local25\Field5) Then
                        local6\Field32[$03] = local25
                        If (local6\Field33[$03] = Null) Then
                            local6\Field33[$03] = local25\Field33[$01]
                        EndIf
                    EndIf
                EndIf
            EndIf
            If (((((local6\Field32[$00] <> Null) And (local6\Field32[$01] <> Null)) And (local6\Field32[$02] <> Null)) And (local6\Field32[$03] <> Null)) <> 0) Then
                Exit
            EndIf
        Next
    Next
