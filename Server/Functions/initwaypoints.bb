    ...
    For local1 = Each waypoints
        ...
        While (local2 <> Null)
            If ((((local1\Field2 = local2\Field2) Or (local1\Field1 <> Null)) Or (local2\Field1 <> Null)) <> 0) Then
                ...
                If (((0.0 = local1\Field2\Field50) Or (0.0 = local2\Field2\Field50)) <> 0) Then
                    local14 = $01
                ElseIf (local1\Field2\Field50 >= (Abs (entityy(local1\Field0, $00) - entityy(local2\Field0, $00)))) Then
                    local14 = $01
                EndIf
                If (7.0 > local9) Then
                    If (local14 <> 0) Then
