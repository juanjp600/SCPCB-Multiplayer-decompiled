Function placegrid_mapcreator%(arg0.rooms)
    ...
    For local1 = $00 To $12 Step $01
        For local0 = $00 To $12 Step $01
            If (arg0\Field31\Field0[((local1 * $13) + local0)] > $00) Then
                local6 = $00
                local7 = $00
                local6 = arg0\Field31\Field0[((local1 * $13) + local0)]
                local7 = (Int ((Float arg0\Field31\Field1[((local1 * $13) + local0)]) * 90.0))
                ...
                Select arg0\Field31\Field0[((local1 * $13) + local0)]
                    Case $01
                ...
                End Select
                arg0\Field31\Field3[((local1 * $13) + local0)] = local8
                local11 = createwaypoint((arg0\Field3 + ((Float local0) * 2.0)), 8.2, (arg0\Field5 + ((Float local1) * 2.0)), Null, arg0)
                arg0\Field31\Field4[((local1 * $13) + local0)] = local11
                If (local1 < $12) Then
                    If (arg0\Field31\Field4[(((local1 + $01) * $13) + local0)] <> Null) Then
                        local12 = (Int entitydistance(arg0\Field31\Field4[((local1 * $13) + local0)]\Field0, arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]\Field0))
                        For local2 = $00 To $03 Step $01
                            If (arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]) Then
                                Exit
                            ElseIf (arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = Null) Then
                                arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]
                                arg0\Field31\Field4[((local1 * $13) + local0)]\Field5[local2] = (Float local12)
                                Exit
                            EndIf
                        Next
                        For local2 = $00 To $03 Step $01
                            If (arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]\Field4[local2] = arg0\Field31\Field4[((local1 * $13) + local0)]) Then
                                Exit
                            ElseIf (arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]\Field4[local2] = Null) Then
                                arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]\Field4[local2] = arg0\Field31\Field4[((local1 * $13) + local0)]
                                arg0\Field31\Field4[(((local1 + $01) * $13) + local0)]\Field5[local2] = (Float local12)
                                Exit
                            EndIf
                        Next
                    EndIf
                ...
                EndIf
                If (local0 > $00) Then
                    If (arg0\Field31\Field4[((local0 - $01) + (local1 * $13))] <> Null) Then
                        local12 = (Int entitydistance(arg0\Field31\Field4[((local1 * $13) + local0)]\Field0, arg0\Field31\Field4[((local0 - $01) + (local1 * $13))]\Field0))
                        For local2 = $00 To $03 Step $01
                            If (arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = arg0\Field31\Field4[((local0 - $01) + (local1 * $13))]) Then
                                Exit
                            ElseIf (arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = Null) Then
                                arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = arg0\Field31\Field4[((local0 - $01) + (local1 * $13))]
                                arg0\Field31\Field4[((local1 * $13) + local0)]\Field5[local2] = (Float local12)
                                Exit
                            EndIf
                        Next
                        For local2 = $00 To $03 Step $01
                            If (arg0\Field31\Field4[((local0 - $01) + (local1 * $13))]\Field4[local2] = arg0\Field31\Field4[((local1 * $13) + local0)]) Then
                                Exit
                            ElseIf (arg0\Field31\Field4[((local1 * $13) + local0)]\Field4[local2] = Null) Then
                                arg0\Field31\Field4[((local0 - $01) + (local1 * $13))]\Field4[local2] = arg0\Field31\Field4[((local1 * $13) + local0)]
                                arg0\Field31\Field4[((local0 - $01) + (local1 * $13))]\Field5[local2] = (Float local12)
                                Exit
                            EndIf
                        Next
                    EndIf
    ...
    Next
    For local2 = $00 To $06 Step $01
        arg0\Field31\Field2[local2] = local3[local2]
    Next
    Return $00
End Function
